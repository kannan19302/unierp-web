...
export function useInvoices() {
  return useApiQuery<ListResponse<any>>(
...
export function useJournals() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.finance.journals(),
    "/advanced-finance/journals",
    { select: normalizeList },
  );
}
...
export function useFixedAssets() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.finance.fixedAssets(),
    "/advanced-finance/fixed-assets",
    { select: normalizeList },
  );
}
export function useBankAccounts() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.finance.bankAccounts(),
    "/advanced-finance/bank-accounts",
    { select: normalizeList },
  );
}
export function useTaxRules() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.finance.taxRules(),
    "/advanced-finance/tax-rules",
    { select: normalizeList },
  );
}
...
export function useLeads(status?: string) {
  ...
  return useApiQuery<ListResponse<any>>(
    [...queryKeys.crm.leads(), status],
    path,
    { select: normalizeList },
  );
}
export function useLead(id: string) {
  return useApiQuery<any>(queryKeys.crm.lead(id), `/crm/leads/${id}`, {
    enabled: !!id,
  });
}
...
export function usePayrollRuns() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.hr.payroll(),
    "/advanced-hr/payroll-runs",
    { select: normalizeList },
  );
}
export function useLeaveRequests() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.hr.leaves(),
    "/advanced-hr/leave-requests",
    { select: normalizeList },
  );
}
export function useAttendanceRecords() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.hr.attendance(),
    "/advanced-hr/attendance",
    { select: normalizeList },
  );
}
...
export function useStockLevels(warehouseId?: string) {
  const path = warehouseId
    ? `/inventory/stock-levels?warehouseId=${warehouseId}`
    : "/inventory/stock-levels";
  return useApiQuery<any>(
    [...queryKeys.inventory.stockLevels(), warehouseId],
    path,
  );
}
export function useStockEntries() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.inventory.stockEntries(),
...
export function useStockLedger() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.inventory.stockLedger(),
...
export function useSerialNumbers() {
  return useApiQuery<any>(
    queryKeys.inventory.serialNumbers(),
...
export function useBinLocations() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.inventory.binLocations(),
...
export function useCycleCounts() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.inventory.cycleCounts(),
...
export function useContracts() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.procurement.contracts(),
...
export function useWorkOrders() {
  return useApiQuery<ListResponse<any>>(
    queryKeys.manufacturing.workOrders(),
...
export function useAiStatus() {
  return useApiQuery<{ configured: boolean }>(
    queryKeys.ai.status(),
    "/ai/status",
  );
}
...
export function useSemanticLayer() {
  return useApiQuery<any[]>(
    queryKeys.reporting.semanticLayer(),
