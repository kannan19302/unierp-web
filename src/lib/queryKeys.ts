export const queryKeys = {
  ...
  crm: {
    ...
    opportunity: (id: string) =>
      [...queryKeys.crm.opportunities(), id] as const,
  ...
  inventory: {
    ...
    serialNumbers: () =>
      [...queryKeys.inventory.all, "serial-numbers"] as const,
  ...
  procurement: {
    ...
    purchaseOrders: () =>
      [...queryKeys.procurement.all, "purchase-orders"] as const,
  ...
  reporting: {
    ...
    semanticLayer: () =>
      [...queryKeys.reporting.all, "semantic-layer"] as const,
  },
