...
export const ALL_FINANCE_MODULES: FinanceModuleDef[] = [
  { href: '/finance/invoices', label: 'Invoices', category: 'OPERATIONS', desc: 'Open invoices workspace', icon: <FileText size={18} /> },
  { href: '/finance/vendor-bills', label: 'Vendor bills', category: 'OPERATIONS', desc: 'Open vendor bills workspace', icon: <FileText size={18} /> },
  { href: '/finance/expenses', label: 'Expenses', category: 'OPERATIONS', desc: 'Open expenses workspace', icon: <FileText size={18} /> },
  { href: '/finance/recurring', label: 'Recurring invoices', category: 'OPERATIONS', desc: 'Open recurring invoices workspace', icon: <FileText size={18} /> },
  { href: '/finance/advanced/intercompany/netting', label: 'Intercompany netting', category: 'TREASURY', desc: 'Open intercompany netting workspace', icon: <FileText size={18} /> },
  { href: '/finance/advanced/intercompany/eliminations', label: 'Intercompany eliminations', category: 'GOVERNANCE', desc: 'Open intercompany eliminations workspace', icon: <FileText size={18} /> },
  { href: '/finance/advanced/fixed-assets/assets', label: 'Asset records', category: 'CORE', desc: 'Open asset records workspace', icon: <FileText size={18} /> },
  // Core Accounting
  {
