      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Employee shoutouts, core value badges, and reward points
          </p>
        </div>
          ...
          <div className="p-3 border rounded-md flex justify-between items-center bg-indigo-50/40">
            <div>
              <p className="font-semibold text-sm">
                🏆 Mark Davis recognized Jessica Wong
              </p>
              <p className="text-xs text-muted-foreground">
                "Awesome job leading the ERP migration deployment cleanly
                overnight!"
              </p>
            </div>
            <span className="bg-indigo-100 text-indigo-800 text-xs px-2.5 py-0.5 rounded font-medium">
              +10 PTS
            </span>
          </div>
        </div>
