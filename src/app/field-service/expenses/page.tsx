  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Technician Work Order Expenses</h1>
          <p className="text-muted-foreground text-sm">On-site parts, travel receipts, and field reimbursement</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="border rounded-lg p-4 bg-card">
          <p className="text-sm font-medium text-muted-foreground">Avg Expense per Ticket</p>
      ...
      <div className="border rounded-lg bg-card p-4">
        ...
        <div className="space-y-3">
          <div className="p-3 border rounded-md flex justify-between items-center bg-muted/40">
            <div>
              <p className="font-semibold text-sm">Work Order #WO-9910 — Emergency Valve Fitting</p>
              <p className="text-xs text-muted-foreground">Tech: David Miller | Category: PARTS | Amount: $280.00</p>
            </div>
            <span className="bg-amber-100 text-amber-800 text-xs px-2.5 py-0.5 rounded font-medium">PENDING</span>
          </div>
        </div>
      </div>
    </div>
