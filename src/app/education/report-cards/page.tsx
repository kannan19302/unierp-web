  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Academic Report Cards</h1>
          <p className="text-muted-foreground text-sm">Student term performance, GPA calculations, and transcripts</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="border rounded-lg p-4 bg-card">
          <p className="text-sm font-medium text-muted-foreground">Generated Cards</p>
        ...
        <div className="border rounded-lg p-4 bg-card">
          <p className="text-sm font-medium text-muted-foreground">Honor Roll Students</p>
        ...
        <div className="space-y-3">
          <div className="p-3 border rounded-md flex justify-between items-center bg-muted/40">
            <div>
              ...
              <p className="text-xs text-muted-foreground">GPA: 3.92 | Status: Published</p>
            </div>
            <button className="border text-xs px-3 py-1.5 rounded font-medium hover:bg-muted">View PDF</button>
          </div>
        </div>
      </div>
    </div>
