  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Rent Collection & Receipts</h1>
          <p className="text-muted-foreground text-sm">Tenant payment tracking, gateway receipts, and late fee processing</p>
        </div>
        ...
        <div className="space-y-3">
          <div className="p-3 border rounded-md flex justify-between items-center bg-muted/40">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Tenant: Robert Taylor | Method: ACH | Amount: $2,400.00</p>
            </div>
            <span className="bg-emerald-100 text-emerald-800 text-xs px-2.5 py-0.5 rounded font-medium">PAID</span>
          </div>
        </div>
      </div>
    </div>
