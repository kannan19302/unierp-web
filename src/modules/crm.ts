...
export const customerResource = defineResource({
  ...
  form: {
    sections: [
      {
        title: "Identity",
        fields: ["name", "type", "customerType", "email", "phone", "taxId"],
      },
      {
  ...
  fields: [
    {
      ...
      type: "text",
      required: true,
      placeholder: "e.g. Arc Reactor Supply Deal",
    },
    {
      name: "customerId",
      label: "Customer",
...
export const caseResource = defineResource({
  ...
  fields: [
    ...
    },
    {
      ...
      label: "Contact",
      type: "link",
      link: { resource: "contacts", labelField: "firstName" },
  ...
  fields: [
    {
      ...
      type: "text",
      required: true,
      placeholder: "e.g. Enterprise Tier Price Book",
    },
    { name: "description", label: "Description", type: "textarea" },
