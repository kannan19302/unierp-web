...
export const financeAuditResource = defineResource({
  ...
  list: {
    columns: ["createdAt", "entityType", "entityId", "action", "userName"],
    searchable: true,
    pageSize: 25,
...
export const financeAuditModule = defineModule({
  id: "finance-audit",
  title: "Finance Audit",
  basePath: "/finance/advanced/audit-logs",
  permission: "finance.audit.read",
  resources: [financeAuditResource],
});
