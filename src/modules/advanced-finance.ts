...
export const exchangeRateResource = defineResource({
  ...
  permissions: {
    read: "finance.treasury.read",
    create: "finance.treasury.create",
  },
  fields: [
    {
      name: "fromCurrency",
...
export const advancedFinanceModule = defineModule({
  id: "advanced-finance",
  title: "Advanced Finance",
  basePath: "/finance/advanced",
  permission: "finance.treasury.read",
  resources: [exchangeRateResource, financialPeriodResource],
});
