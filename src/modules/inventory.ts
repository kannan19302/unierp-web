  ...
  form: {
    sections: [
      { title: "Identification", fields: ["sku", "name", "type", "unit"] },
      {
        ...
        fields: ["costPrice", "sellPrice", "category", "description"],
      },
    ],
  },
});
...
export const stockLedgerResource = defineResource({
  ...
  fields: [
    ...
    { name: "balanceQty", label: "Balance", type: "number", readOnly: true },
    {
      ...
      label: "Product",
      type: "link",
      link: { resource: "products", labelField: "name" },
      readOnly: true,
    },
    {
      name: "warehouseId",
      label: "Warehouse",
      type: "link",
      link: { resource: "warehouses", labelField: "name" },
      readOnly: true,
    },
  ],
  list: {
...
export const serialNumberResource = defineResource({
  ...
  list: {
    ...
    searchable: true,
    pageSize: 25,
    defaultSort: { field: "serialNo", direction: "asc" },
    filters: ["productId", "status"],
    selectable: true,
  },
});
...
export const cycleCountScheduleResource = defineResource({
  ...
  list: {
    ...
    searchable: false,
    pageSize: 25,
    defaultSort: { field: "nextDueDate", direction: "asc" },
    filters: ["warehouseId", "active"],
    selectable: true,
  },
});
...
export const productVariantResource = defineResource({
  ...
  form: {
    sections: [
      { fields: ["sku", "name", "color", "size", "costPrice", "sellPrice"] },
    ],
  },
});
