...
export const CRM_TABS: ModuleTab[] = [
  ...
  },
  {
    ...
    href: "/crm/journey",
    icon: MapPin,
    description: "Customer journey, NPS, churn, CLV, and 360 view",
    advanced: true,
    group: "Advanced",
  },
  {
  ...
  },
  {
    ...
    group: "Sales Pipeline",
    description:
      "Advanced CPQ, product bundles, pricing rules, and quote analysis",
  },
  ...
  },
  {
    ...
    group: "CRM Intelligence & AI",
    description:
      "AI-powered win probability, deal health, next best action, revenue intelligence, and sales velocity",
  },
  {
    id: "ai-win-probability",
    label: "Win Probability",
    href: "/crm/ai-intelligence/win-probability",
    icon: Brain,
    advanced: true,
    group: "CRM Intelligence & AI",
    description: "AI win probability scoring with rationale",
  },
  {
    ...
    advanced: true,
    group: "CRM Intelligence & AI",
    description: "Recommended next actions for pipeline deals",
  },
  {
    id: "ai-deal-health",
    label: "Deal Health",
    ...
    advanced: true,
    group: "CRM Intelligence & AI",
    description: "Deal health scores and factor analysis",
  },
  {
    id: "ai-pipeline-anomalies",
    ...
    group: "CRM Intelligence & AI",
    description:
      "Anomaly detection, activity recommendations, conversion predictors",
  },
  {
    ...
    group: "CRM Intelligence & AI",
    description:
      "Revenue digests, trends, by stage/source/territory, forecast accuracy",
  },
  {
    id: "ai-sales-velocity",
    label: "Sales Velocity",
    href: "/crm/ai-intelligence/sales-velocity",
    icon: Brain,
    advanced: true,
    group: "CRM Intelligence & AI",
    description: "Sales velocity metrics, trends, by rep/product, cycle time",
  },
  {
    ...
    group: "CRM Intelligence & AI",
    description:
      "Competitor tracking, intelligence reports, win/loss categories, landscape analysis",
  },
  {
    id: "competitor-intelligence-reports",
    label: "Competitor Reports",
    href: "/crm/competitor-intelligence/reports",
    icon: Target,
    advanced: true,
    group: "CRM Intelligence & AI",
    description: "SWOT, pricing, and market intelligence reports",
  },
  {
    ...
    advanced: true,
    group: "CRM Intelligence & AI",
    description: "Full competitive landscape with SWOT and positioning",
  },
  {
    id: "win-loss-categories",
    label: "Win/Loss Categories",
    href: "/crm/competitor-intelligence/win-loss-categories",
    icon: Target,
    advanced: true,
    group: "CRM Intelligence & AI",
    description: "Win/loss reason category management",
  },
