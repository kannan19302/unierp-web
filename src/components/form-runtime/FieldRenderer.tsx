...
export function FieldRenderer({
  ...
  switch (field.type) {
    ...
    case "Radio": {
      ...
      return (
        <div
          className={`ui-radio-group ${field.cssClass || ""}`.trim()}
          style={{
            display: "flex",
    ...
    case "Text Editor":
      return (
        <textarea
          {...commonProps}
          style={{ ...commonProps.style, minHeight: customHeight || "120px" }}
    ...
    case "Image":
      return (
        <input
          type="file"
          {...commonProps}
          style={{ ...commonProps.style, padding: "var(--space-1)" }}
        />
      );
    case "Signature":
      return (
      ...
      return (
        <div
          ...
          dangerouslySetInnerHTML={{
            __html: field.options || "<em>Custom HTML Content</em>",
          }}
        />
      );
    case "Button":
      return (
        <button
          className={`ui-btn ui-btn-secondary ${field.cssClass || ""}`.trim()}
          style={{ width: "100%", height: customHeight }}
          disabled={previewMode && field.readOnly}
        >
          {field.label}
        ...
        <div style={{ position: "relative", height: customHeight }}>
          ...
          <input
            ...
            style={{
              ...
              height: "100%",
              paddingLeft:
                field.type === "Currency" ? "28px" : "var(--space-2)",
            }}
            placeholder={
              field.placeholder || `0${field.type === "Currency" ? ".00" : ""}`
            }
          />
        </div>
      );
