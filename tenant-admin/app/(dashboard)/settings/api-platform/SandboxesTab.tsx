        ...
        {sandboxes.map((sb: any) => (
          ...
          >
            ...
            <div className={styles.s7}>
              <div>
                <div className="ui-text-micro">Data</div>
                <div className="ui-heading-sm">{sb.dataSize}</div>
              </div>
              <div>
                <div className="ui-text-micro">API Calls</div>
                <div className="ui-heading-sm">
                  {sb.apiCalls.toLocaleString()}
                </div>
              </div>
              <div>
                <div className="ui-text-micro">Expires</div>
                <div className="ui-heading-sm">{sb.expiresAt}</div>
              </div>
            </div>
