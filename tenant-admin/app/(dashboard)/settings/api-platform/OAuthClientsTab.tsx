  ...
  const [oauthClients] = useState([
    {
      ...
      clientId: "qb_sync_28a4f1...",
      redirectUri: "https://quickbooks.intuit.com/callback",
    ...
    {
      id: "cl-2",
      name: "Salesforce CRM Bridge",
      clientId: "sf_crm_7b9c3e...",
      redirectUri: "https://login.salesforce.com/callback",
      scopes: ["crm.read", "contacts.write"],
      status: "ACTIVE",
    ...
    },
    {
      ...
      clientId: "shop_con_d45e2...",
      redirectUri: "https://accounts.shopify.com/callback",
    ...
    <div className="ui-stack-4">
      ...
      {oauthClients.map((c: any) => (
        ...
        >
          ...
          <div className="ui-flex ui-gap-2">
            ...
            {c.status === "ACTIVE" && (
              <button className={styles.s13}>Revoke</button>
            )}
          </div>
        </div>
      ))}
      ...
      <div className="ui-card p-5">
        <h3 className={styles.s14}>
          <Shield size={16} className="ui-text-primary" /> SAML 2.0 / OIDC
          Configuration
        </h3>
        <div className="ui-grid-2 ui-gap-3">
          {[
            ...
            {
              label: "Entity ID",
              value: "https://unerp.dev/saml/metadata",
              placeholder: "Entity ID...",
            },
            {
              label: "SSO URL",
              value: "https://acme.okta.com/app/unerp/sso/saml",
              placeholder: "SSO URL...",
            },
            {
              label: "Certificate",
