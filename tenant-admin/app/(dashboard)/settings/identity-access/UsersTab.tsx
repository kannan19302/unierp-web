...
const AVAILABLE_ROLES = [
  { id: "role-organization-owner", name: "Organization Owner", description: "Full tenant-scoped access" },
    ...
    async (page = 1) => {
      ...
      try {
        ...
        const data = await client.get<
          UserData[] | { data?: UserData[]; meta?: PaginationMeta }
        >(`/admin/users?${params}`);
      ...
      render: (row: any) => (
        <div className="ui-hstack-3">
          ...
          <div>
            ...
            <div className="ui-text-xs-tertiary">{row.email}</div>
          </div>
        </div>
      ),
    },
    ...
    <div className="ui-stack-6">
      ...
      >
        <form onSubmit={handleInvite} className="ui-stack-4">
          {inviteError && <div className={styles.s11}>{inviteError}</div>}
          ...
          <div className={styles.s15}>
            ...
            <div className="ui-hstack-4">
              ...
              <div>
                ...
                <p className={styles.s18}>{selectedUser.email}</p>
            ...
            <div className="ui-grid-2">
              <DetailField
                label="Last Active"
                value={timeAgo(selectedUser.lastLoginAt)}
              />
              <DetailField
                label="Joined"
              ...
              <DetailField
                label="Department"
                value={selectedUser.department || "Unassigned"}
              />
              <DetailField
                label="User ID"
                value={selectedUser.id.slice(0, 12) + "..."}
                mono
              />
            </div>
            ...
            {/* Quick Actions */}
            <div className="ui-stack-2">
              <h4 className={styles.s25}>Actions</h4>
              <Button variant="outline" onClick={() => {}}>
