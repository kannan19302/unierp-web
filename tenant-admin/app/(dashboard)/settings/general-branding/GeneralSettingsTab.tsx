...
import { Card, Button, Spinner, Badge, TextField, FormField, Select } from "@kannan19302/ui";
    ...
    (async () => {
      try {
        ...
        setForm({
          ...
          primaryColor: settings.primaryColor || "var(--chart-10)",
          invoicePrefix: settings.invoicePrefix || "INV-",
          poPrefix: settings.poPrefix || "PO-",
          soPrefix: settings.soPrefix || "SO-",
          fiscalYearStartMonth:
            org.fiscalYearStartMonth || settings.fiscalYearStartMonth || 1,
        });
      } catch {
        /* use defaults */
      } finally {
  ...
  return (
    <div className={styles.s1}>
      ...
      <SettingsSection
        ...
        title="Fiscal Year"
        description="Set your organization's fiscal year start month"
      >
      ...
      <SettingsSection
        ...
        description="Configure document number prefixes"
      >
      ...
      <SettingsSection
        ...
        title="Demo Data"
        description="Load or remove sample data for testing and evaluation"
      >
