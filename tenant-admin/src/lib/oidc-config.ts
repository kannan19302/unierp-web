 ...
 * "unierp-tenant-admin", seeded by data/prisma/seed-oidc-clients.ts as a PUBLIC
...
export const oidcConfig: OidcClientConfig = {
  ...
  clientId: "unierp-tenant-admin",
  redirectUri:
    (typeof window !== "undefined" ? window.location.origin : "http://localhost:4006") +
    "/auth/callback",
