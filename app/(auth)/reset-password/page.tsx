...
function ResetPasswordContent() {
  ...
  useEffect(() => {
    if (!token) {
      setError(
        "Password recovery token is missing. Please request a new link.",
      );
    }
  }, [token]);
    ...
    <div className="auth-container">
      ...
      <div className="auth-sidebar auth-sidebar-purple">
        ...
        <div className="auth-sidebar-content">
          ...
          <p>
            Choose a strong password combining letters, numbers, and special
            symbols to prevent unauthorized access.
          </p>
        </div>
      </div>
          ...
          <div className="auth-card">
            {success ? (
              <div className={styles.s5}>
                ...
                <h3 className={styles.s7}>Password Reset Complete!</h3>
              ...
              <form onSubmit={handleSubmit} className={styles.s9}>
                ...
                <div className="auth-field-group">
                  ...
                  {!passwordsMatch && (
                    <p className={styles.s16}>Passwords do not match</p>
                  )}
                </div>
                ...
                <button
                  ...
                  disabled={
                    loading || !token || !passwordsMatch || password.length < 8
                  }
                >
                  {loading ? (
                    <>
