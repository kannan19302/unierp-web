...
export default function AdvancedInventoryPage() {
  ...
  const [modalType, setModalType] = useState<
    "category" | "uom" | "conversion" | "rule" | "kit"
  >("category");
  ...
  const [kitComps, setKitComps] = useState<
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (modalType === "category") {
      ...
      payload = {
        productId: ruleProd,
        warehouseId: ruleWh || undefined,
        minQty: Number(ruleMin),
        maxQty: ruleMax ? Number(ruleMax) : undefined,
        reorderQty: Number(ruleReorder),
        leadTimeDays: Number(ruleLead),
      };
