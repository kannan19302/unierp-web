...
import { Card, PageHeader, Button, ListPageTemplate, type ListColumn } from "@kannan19302/ui";
...
export default function MovementHistoryPage() {
  ...
  const [labelType, setLabelType] = useState<
    "product" | "batch" | "license-plate" | "bin"
  >("product");
  ...
  const search = async () => {
    ...
    try {
      ...
      const data = await client.get<{ movements?: Movement[] }>(
        `/inventory/movement-history?${params.toString()}`,
      );
