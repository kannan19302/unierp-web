      ...
      <div className="p-6 space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage load planning, container utilization, and packing operations
          </p>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-500 mt-1">
                      Origin: {lp.originWarehouse} · {lp.pallets.length} pallets
                      · {lp.items.length} items ·{" "}
                  ...
                  <div className="flex gap-2">
                    ...
                    {lp.status === "OPTIMIZING" && (
                      <button
                        onClick={() => transition("load-plans", lp.id, "ready")}
                    ...
                    {lp.status === "LOADED" && (
                      <button
                        onClick={() => transition("load-plans", lp.id, "ship")}
