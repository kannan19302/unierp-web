...
import { PageHeader, Card, DataTable, type Column, Button, Modal, TextField, Badge, KPICard } from "@kannan19302/ui";
...
export default function WarehouseKpisPage() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      setData(await client.get("/inventory/warehouse-kpis"));
    } catch {
      /* empty */
    } finally {
      setLoading(false);
  ...
  return (
    <div className="ui-page">
      <PageHeader
        ...
        description="Track warehouse performance metrics"
        actions={
          <Button variant="primary" onClick={() => setCreateOpen(true)}>
            <Plus size={14} /> Record KPI
          </Button>
        }
      />
      <div className="ui-grid-4" style={{ marginBottom: "1.5rem" }}>
        <KPICard
          title="Avg Picks/Hour"
          value={avgPicks}
