  ...
  const loadTemplate = async (termId: string) => {
    try {
      const data = await client.get<{
        ...
        layoutFormat?: string;
      }>(`/pos/terminals/${termId}/receipt-template`);
  ...
  const handleSave = async () => {
    ...
    try {
      await client.request(
        `/pos/terminals/${selectedTerminal}/receipt-template`,
        {
          method: "PUT",
      ...
      <div className={styles.p1}>
        <div>
          ...
          <p className="ui-text-sm-muted">
            Customize standard A4 invoices or raw thermal 80mm/58mm printing
            styles using CSS templates.
          </p>
        </div>
        ...
        <div className={styles.p2}>
          ...
          <div className={["ui-card", styles.p3].join(" ")}>
            ...
            <div className="ui-form-group">
              ...
              >
                ...
                <option value="THERMAL_58MM">
                  58mm Raw Thermal Paper Layout
                </option>
                <option value="A4_INVOICE">
                  Standard A4 Invoice PDF Layout
                </option>
                <option value="CUSTOM_CSS">
                  User-defined Custom CSS Compiled Layout
                </option>
              </select>
            </div>
          ...
          <div className={["ui-card", styles.p13].join(" ")}>
            ...
            <div
              style={{
                maxWidth:
                  layoutFormat === "THERMAL_58MM"
                    ? "240px"
                    : layoutFormat === "THERMAL_80MM"
                      ? "320px"
                      : "100%",
              }}
            >
