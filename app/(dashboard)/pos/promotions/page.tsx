    ...
    <div className="ui-stack-6">
      <div>
        ...
        <p className="ui-text-sm-muted">
          Create and manage promotional rules, bundle deals, and time-based
          offers.
        </p>
      </div>
      ...
      <div className="ui-flex-between">
        <div className="ui-flex ui-gap-2">
          <span className="ui-text-sm-muted">
            Active promotions are automatically applied at checkout when
            conditions are met.
          </span>
        </div>
      ...
      <div className="ui-card p-5">
        ...
        <div className={styles.p2}>
          {[
            {
              name: "Buy X Get Y (BOGO)",
              desc: "Buy a specific product and get another free or discounted",
              type: "BOGO",
            },
            {
              name: "Bundle Discount",
              desc: "Discount when purchasing a set of products together",
              type: "BUNDLE",
            },
            {
              name: "Percentage Off",
              desc: "Percentage discount on order, item, or category",
              type: "PERCENTAGE",
            },
            {
