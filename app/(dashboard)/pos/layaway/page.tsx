    ...
    <div className="ui-stack-6">
      <div>
        ...
        <p className="ui-text-sm-muted">
          Create and manage layaway plans with deposit and installment payments.
        </p>
      </div>
          ...
          {[
            {
              step: "1",
              title: "Create Plan",
              desc: "Select items and set a deposit amount to reserve them.",
            },
            {
              step: "2",
              title: "Collect Payments",
              desc: "Customer makes installment payments over time.",
            },
            {
              step: "3",
              title: "Complete",
