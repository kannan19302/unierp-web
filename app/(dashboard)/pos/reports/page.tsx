      ...
      <div className="ui-stack-6">
        <div>
          ...
          <p className="ui-text-sm-muted">
            Daily sales summary, payment breakdown, and performance metrics.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <>
            <div className={styles.p2}>
              {[
                ...
                {
                  label: "Returns",
                  value: `$${(summary.totalReturns ?? 0).toFixed(2)}`,
          ...
          <div className={styles.p6}>
            No sales data available. Complete a POS transaction to see
            analytics.
          </div>
        )}
            ...
            {[
              {
                ...
                endpoint: "/api/v1/pos/reports/sales-by-product",
                icon: <ShoppingBag size={16} />,
              },
              {
                label: "Sales by Cashier",
                endpoint: "/api/v1/pos/reports/sales-by-cashier",
                icon: <Users size={16} />,
              },
              {
                label: "Sales by Hour",
                endpoint: "/api/v1/pos/reports/sales-by-hour",
                icon: <Clock size={16} />,
              },
              {
                label: "Sales by Payment",
                endpoint: "/api/v1/pos/reports/sales-by-payment",
                icon: <CreditCard size={16} />,
              },
              {
                label: "Discount Usage",
                endpoint: "/api/v1/pos/reports/discount-usage",
