...
export default function ProcurementDashboard() {
  ...
  const handleKanbanMove = async (
    ...
    try {
      await client.patch(`/procurement/purchase-orders/${itemId}`, {
        status: toColumn,
      });
      loadDashboardData();
    } catch {
                ...
                renderCard={(item) => (
                  <div>
                    ...
                    <div className="ui-flex-between">
                      <span className="ui-text-micro">{item.orderDate}</span>
                    </div>
                  </div>
                )}
              />
                      ...
                      <div className="ui-hstack-3">
                        ...
                        <div>
                          ...
                          <span className="ui-text-xs-muted">
                            Draft, approve, and track vendor POs
                          </span>
                        </div>
                      </div>
                      <div className={styles.p9}>
                        <span className="ui-text-xs-muted">
                          {pendingOrdersCount} orders pending approval
                        </span>
                        <Link
                ...
                <div className={styles.p19}>
                  <Card padding="none">
                    ...
                    <div className={styles.p23}>
                      <p className={styles.p24}>
                        Compare bids sent back from vendors corresponding to
                        RFQs. Evaluate pricing matrices and automatically
                        convert approved quotations to Purchase Orders.
                      </p>
                  ...
                  <Card padding="none">
                    <div className={styles.p27}>
                      ...
                      <Link href="/procurement/vendors" className={styles.p29}>
                        View All
                      </Link>
                    </div>
                    <div className={styles.p30}>
                      <p className={styles.p31}>
                        Manage supplier profiles, contact details, payment
                        terms, and historical logs of purchase transactions.
                      </p>
