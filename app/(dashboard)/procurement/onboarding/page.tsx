...
import { PageHeader, Card, DataTable, type Column, Button, Modal, TextField, Badge, StatusBadge } from "@kannan19302/ui";
...
export default function OnboardingPage() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      setData(await client.get("/procurement/supplier-onboarding"));
    } catch {
      /* empty */
    } finally {
      setLoading(false);
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setCreateOpen(false);
      setForm({ vendorId: "", vendorName: "", taxId: "", notes: "" });
      fetchData();
    } catch {
      /* empty */
    } finally {
  ...
  return (
    <div className="ui-page">
      <PageHeader
        ...
        description="Manage supplier registration and qualification workflows"
        actions={
