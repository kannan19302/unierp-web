...
export default function RequisitionsPage() {
  ...
  const handleConvertToPO = async (id: string) => {
    try {
      ...
      alert(
        "Successfully converted Purchase Requisition into a Purchase Order draft.",
      );
      loadData();
      setSelectedRequisition(null);
    } catch {
    ...
    <div className={styles.p7}>
      {[
        ...
        <button
          ...
          style={{
            background:
              statusFilter === status ? "var(--color-primary)" : "transparent",
            color:
              statusFilter === status
                ...
                <div className={styles.p15}>
                  <div className="ui-flex-between mb-2">
                    ...
                    <Button
                      ...
                      className={["ui-btn ui-btn-secondary", styles.p17].join(
                        " ",
                      )}
                    >
                  ...
                  <div className="ui-stack-2">
                    {items.map((item, idx) => (
                      <div key={idx} className={styles.p19}>
                        ...
                        >
                          <label className={["ui-label", styles.p21].join(" ")}>
                            Item Product
                          </label>
                          <select
                        ...
                        <div
                          className={["ui-form-group", styles.p22].join(" ")}
                        >
                          <label className={["ui-label", styles.p23].join(" ")}>
                            Description
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="ui-form-group flex-1">
                          <label className={["ui-label", styles.p24].join(" ")}>
                            Qty
                          </label>
                          <input
                            type="number"
                        ...
                        <div
                          className={["ui-form-group", styles.p25].join(" ")}
                        >
                          <label className={["ui-label", styles.p26].join(" ")}>
                            Est. Price ($)
                          </label>
                          <input
                            type="number"
                ...
                <div className={["ui-grid-3", styles.p40].join(" ")}>
                  ...
                  <div>
                    ...
                    <div className={styles.p43}>
                      $
                      {Number(
                        selectedRequisition.estimatedCost,
                      ).toLocaleString()}
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.p44}>
                  ...
                  {selectedRequisition.approvedBy && (
                    <>
                      <div>
                        Approved By:{" "}
                        <span className={styles.p46}>
                          {selectedRequisition.approvedBy}
                        </span>
                      </div>
                      <div>
                        Approved At:{" "}
                        <span className={styles.p47}>
                          {new Date(
                ...
                <div className={styles.p48}>
                  ...
                  {selectedRequisition.status === "PENDING_APPROVAL" && (
                    <>
                      <Button
                        onClick={() =>
                          handleUpdateStatus(selectedRequisition.id, "reject")
                        }
                      ...
                      <Button
                        onClick={() =>
                          handleUpdateStatus(selectedRequisition.id, "approve")
                        }
