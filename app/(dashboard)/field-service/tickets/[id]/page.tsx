...
export default function ServiceTicketDetailPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        notifyError("Failed to load ticket", message);
      } finally {
        setLoading(false);
      }
    })();
  }, [client, id, notifyError]);
  ...
  if (loadError && !ticket)
    return (
      <div className={styles.s1}>
        ...
        <Link href="/field-service/tickets">
  ...
  if (!ticket)
    return (
      <div className={styles.s1}>
        <ClipboardList size={64} className="ui-text-tertiary" />
  ...
  return (
    <RouteGuard permission="field-service.ticket.read">
      <div className="ui-stack-6">
        ...
        <Card>
          <div className="p-5">
            <h3 className="ui-heading-base mb-4">Ticket Details</h3>
            {[
              ["Title", ticket.title],
