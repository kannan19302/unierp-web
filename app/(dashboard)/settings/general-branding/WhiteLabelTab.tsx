...
export default function WhiteLabelTab() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setFeedback({
        msg: "White-label settings saved successfully!",
        ok: true,
      });
  ...
  return (
    <div className={styles.s1}>
      <div className={styles.s2}>
        ...
        <button onClick={handleSave} disabled={saving} className={styles.s4}>
          {saving ? (
            "Saving..."
          ) : (
            <>
        ...
        <div className={styles.s16}>
          <div>
            ...
            <p className={styles.s18}>
              Allow users to install this ERP as a native application on their
              devices.
            </p>
          </div>
