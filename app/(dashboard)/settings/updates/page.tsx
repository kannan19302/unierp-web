        ...
        <div className="ui-flex-between">
          <div>
            ...
            <p className="ui-text-sm-muted">
              Check for core software version upgrades, view release logs, and
              manage automated upgrade triggers.
            </p>
          </div>
          <button
          ...
          >
            <RefreshCw
              size={12}
              className={checking || loading ? "spin" : ""}
            />
            Check for updates
          </button>
        </div>
                ...
                <div className={styles.statusDetails}>
                  ...
                  <div>
                    ...
                    <p className={styles.statusDescription}>
                      ...
                      • Latest Version: <strong>{status.latestVersion}</strong>
                    </p>
                  </div>
                </div>
                {status.updateAvailable && (
                  <button className={styles.applyButton}>Apply Upgrade</button>
                )}
              </div>
                ...
                <div className="ui-stack-4">
                  {status.releaseNotes.map((note: any, idx: any) => (
                    <div
                      key={idx}
                      className={
                        idx < status.releaseNotes.length - 1
                          ? styles.releaseNote
                          : undefined
                      }
                    >
