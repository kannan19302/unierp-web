    ...
    <div className="ui-stack-4">
      <div className="ui-card p-5">
        ...
        <p className={styles.p1}>
          Configure conditional routing logic below. Active rules will
          dynamically assign assignees on trigger.
        </p>
        {[
          {
            condition: "Purchase Order Amount > $10,000",
            route: "CFO",
            fallback: "VP Finance",
            active: true,
          },
          ...
          {
            condition: 'Invoice Vendor = "Preferred"',
            route: "Auto-Approve",
            fallback: "AP Manager",
            active: true,
          },
          {
            condition: 'Travel Expense Region = "International"',
            route: "Global Travel Manager",
            fallback: "VP Operations",
            active: false,
          },
          {
            condition: "Budget Transfer > 20% of Department Budget",
            route: "CEO",
            fallback: "CFO",
            active: true,
          },
