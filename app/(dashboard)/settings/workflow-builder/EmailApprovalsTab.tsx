    ...
    <div className="ui-stack-4">
      <div className="ui-card p-5">
        ...
        <p className={styles.p1}>
          Approvers receive email alerts formatted like below, allowing secure
          actions directly from inbox client.
        </p>
        ...
        <div className={styles.p2}>
          ...
          <div className={styles.p5}>
            ...
            <p className={styles.p7}>
              A <strong>Purchase Order (PO-2026-0285)</strong> requires your
              approval:
            </p>
            <div className={styles.p8}>
              <div>
                <strong>Item:</strong> Machine Parts — Urgent Repair
              </div>
              <div>
                <strong>Amount:</strong> $12,800.00
              </div>
              <div>
                <strong>Requested by:</strong> Ops Manager
              </div>
              <div>
          ...
          <div className={styles.p9}>
            <button className={styles.p10}>Approve</button>
            <button className={styles.p11}>Reject</button>
          </div>
      ...
      <div className="ui-card p-5">
        ...
        {[
          {
            label: "Enable Email Approvals",
            desc: "Send approval emails with one-click action buttons",
            enabled: true,
          },
          {
            label: "Secure Token Expiry",
            desc: "Set to 24 hours — action links expire after this period",
            enabled: true,
          },
          {
            label: "CC Requester on Decision",
            desc: "Automatically CC the original requester when approved/rejected",
            enabled: true,
          },
          {
          ...
          >
            ...
            >
              <div
                style={{ left: opt.enabled ? "20px" : "2px" }}
                className={styles.s3}
              />
            </div>
          </div>
