...
export default function DbSchemaPage() {
  ...
  const fetchSchema = async () => {
    ...
    try {
      setTables(
        await client.get<DbTableMetadata[]>("/admin/operations/db-schema"),
      );
    } catch (e) {
      console.error(e);
    } finally {
        ...
        <div className="ui-flex-between">
          <div>
            ...
            <p className="ui-text-sm-muted">
              Examine current active PostgreSQL public schema tables, fields,
              structural models, and row volumes.
            </p>
          </div>
          <button
            onClick={fetchSchema}
              ...
              },
              {
                ...
                render: () => (
                  <div className="text-right">
                    <button className={styles.s7}>Inspect Columns</button>
                  </div>
                ),
              },
            ] as ListColumn[]
