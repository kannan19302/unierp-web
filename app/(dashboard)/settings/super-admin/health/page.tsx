  ...
  return (
    <RouteGuard permission="system.health.read">
      <div className="ui-stack-6">
        ...
        {error && <div className={`${styles.warning} ui-card`}>{error}</div>}
        ...
        <div className="ui-flex-between">
          ...
          <button className="ui-btn ui-hstack-2" onClick={fetchHealth}>
            <RefreshCw size={14} />
            Refresh
          </button>
        </div>
          ...
          <Card>
            <div className={styles.metricCard}>
              ...
              <div
                ...
                style={{ color: latencyColor(health?.dbLatency ?? 0) }}
              >
                {health?.dbLatency ?? "—"} ms
              </div>
          ...
          <Card>
            <div className={styles.metricCard}>
              ...
              <div
                ...
                style={{
                  color: memoryColor(
                    health?.memoryUsage?.heapUsed ?? 0,
                    health?.memoryUsage?.heapTotal ?? 1,
                  ),
                }}
              >
