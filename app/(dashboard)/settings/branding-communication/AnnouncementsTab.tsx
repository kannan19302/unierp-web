...
const MOCK_ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    message:
      "System will be under maintenance on June 25 from 2:00 AM to 4:00 AM UTC.",
    type: "warning",
    priority: "high",
    isActive: true,
  ...
  },
  {
    ...
    message:
      "You can now schedule automated reports from the Administration panel.",
    type: "info",
    priority: "normal",
    isActive: true,
    expiresAt: null,
  ...
  },
  {
    ...
    message:
      "Please update your password before July 1. Passwords older than 90 days will be expired.",
    type: "critical",
    priority: "high",
    isActive: true,
...
export default function AnnouncementsTab() {
  ...
  const openEdit = (a: Announcement) => {
    ...
    setFormExpires(a.expiresAt ? a.expiresAt.slice(0, 10) : "");
    setEditingId(a.id);
    setModalOpen(true);
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editingId) {
        await client.request(`/admin/announcements/${editingId}`, {
          method: "PATCH",
            ...
            <div className="ui-flex-between ui-items-start">
              <div className="flex-1">
                <div className={styles.s3}>
                  ...
                  <span style={typeBadgeStyle(a.type)}>
                    {typeIcon(a.type)} {a.type}
                  </span>
                  {!a.isActive && <span className={styles.s5}>Inactive</span>}
                </div>
                <p className={styles.s6}>{a.message}</p>
