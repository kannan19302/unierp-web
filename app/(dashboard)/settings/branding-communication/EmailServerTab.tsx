...
export default function EmailServerTab() {
  ...
  const handleSendTest = async () => {
    ...
    setTestStatus(null);
    try {
      await client.post("/admin/platform/smtp", {
        ...config,
      ...
      setTestStatus({
        ...
        message:
          error instanceof Error
            ? error.message
            : "SMTP connection check failed. Verify parameters.",
      });
    } finally {
      setLoading(false);
    }
        ...
        <div className="ui-card p-5">
          <form onSubmit={handleSave} className="ui-stack-4">
            ...
            <div className={styles.p6}>
              ...
              />
              <label htmlFor="smtp-active" className="text-sm">
                Enable SMTP Settings globally for this tenant
              </label>
            </div>
            ...
            <div className={styles.p7}>
              ...
              {saved && (
                <span className={styles.p8}>
                  <CheckCircle size={12} /> SMTP Configuration Saved
                </span>
              )}
            </div>
          </form>
        ...
        <div className="ui-stack-4">
          <div className="ui-card p-5">
            ...
            <p className={styles.p10}>
              Save settings and input a recipient email address to dispatch a
              test system email.
            </p>
            ...
            {testStatus && (
              ...
              >
                {testStatus.success ? (
                  <CheckCircle size={14} className={styles.p12} />
                ) : (
                  <AlertCircle size={14} className={styles.p13} />
                )}
