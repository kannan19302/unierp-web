  ...
  return (
    <div>
      ...
      <div className={styles.s8}>
        <button
          onClick={() => setConfirmModal({ type: "purge" })}
          className={styles.s9}
        >
            ...
            [
              {
                ...
                render: (v) => (
                  <span
                    ...
                    style={{
                      background: `${badgeColor(String(v))}18`,
                      color: badgeColor(String(v)),
                    }}
                  >
                    {String(v)}
                  </span>
              ...
              },
              {
                ...
                render: (v, row) => (
                  <div className="ui-flex ui-gap-2">
                    ...
                    <button
                      onClick={() =>
                        setConfirmModal({ type: "delete", id: String(v) })
                      }
      ...
      <div className="ui-flex-between">
        <span className="ui-text-sm-muted">
          {meta.total} item{meta.total !== 1 ? "s" : ""} &middot; Page{" "}
