  ...
  const [pendingApprovals, setPendingApprovals] = useState<PendingApproval[]>([
    {
      ...
      description: "Office Supplies — Q3 Stock",
      requestedBy: "Jane Smith",
      requestedAt: "2026-06-14 09:15",
      amount: 4500,
      priority: "MEDIUM",
      slaDeadline: "2026-06-15 09:15",
      selected: false,
    },
    {
      id: "pa-2",
      entityType: "Leave Request",
      entityId: "LR-2026-0042",
      description: "Annual Leave — 5 days",
      requestedBy: "Mike Johnson",
      requestedAt: "2026-06-14 08:30",
      amount: 0,
      priority: "LOW",
      slaDeadline: "2026-06-16 08:30",
      selected: false,
    },
    {
      id: "pa-3",
      entityType: "Invoice",
      entityId: "INV-2026-0198",
      description: "Vendor Payment — Steel Corp",
      requestedBy: "Finance Team",
      requestedAt: "2026-06-13 16:00",
      amount: 28500,
      priority: "HIGH",
      slaDeadline: "2026-06-14 16:00",
      selected: false,
    },
    {
      id: "pa-4",
      entityType: "Travel Expense",
      entityId: "EXP-2026-0056",
      description: "Client Visit — NYC Trip",
      requestedBy: "Sarah Chen",
      requestedAt: "2026-06-13 14:20",
      amount: 2350,
      priority: "MEDIUM",
      slaDeadline: "2026-06-15 14:20",
      selected: false,
    },
    {
      id: "pa-5",
      entityType: "Purchase Order",
      entityId: "PO-2026-0285",
      description: "Machine Parts — Urgent Repair",
      requestedBy: "Ops Manager",
      requestedAt: "2026-06-13 11:00",
      amount: 12800,
      priority: "CRITICAL",
      slaDeadline: "2026-06-14 11:00",
      selected: false,
    },
    {
      id: "pa-6",
      entityType: "Budget Transfer",
      entityId: "BT-2026-0012",
      description: "Marketing → R&D Reallocation",
      requestedBy: "CFO Office",
      requestedAt: "2026-06-12 15:30",
      amount: 50000,
      priority: "HIGH",
      slaDeadline: "2026-06-14 15:30",
      selected: false,
    },
  ]);
