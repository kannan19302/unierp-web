  ...
  const handleAddDomain = async (e: React.FormEvent) => {
    ...
    try {
      await client.post("/admin/platform/domains", { domain: newDomain });
      {
        setNewDomain("");
        setFeedback(
          `Custom domain request added. Configure DNS settings to verify.`,
        );
      ...
      <div className={styles.p1}>
        <div>
          ...
          <p className="ui-text-sm-muted">
            Link custom brand domains and verify domain ownership settings via
            hosting DNS records.
          </p>
        </div>
          ...
          <form onSubmit={handleAddDomain} className="ui-stack-4">
            ...
            <div className="ui-flex ui-gap-3">
              ...
              <button
                ...
                style={{ cursor: adding || !newDomain ? "wait" : "pointer" }}
                className={styles.s1}
              >
          ...
          <div className="ui-stack-4">
                ...
                {d.status === "VERIFYING" && (
                  <div className={styles.p7}>
                    <h4 className={styles.p8}>
                      <AlertCircle size={12} /> Complete DNS Configuration to
                      Verify Domain
                    </h4>
                    <p className={styles.p9}>
                      Add the following DNS records inside your domain registry
                      configuration (e.g. Cloudflare, GoDaddy):
                    </p>
            ...
            {domains.length === 0 && (
              <div className={styles.p13}>
                No custom domains added. You are currently browsing from the
