...
export default function TenantAnalyticsPage() {
  ...
  const fetchAnalytics = async () => {
    ...
    try {
      setAnalytics(
        await client.get<TenantAnalytics>("/admin/platform/usage-analytics"),
      );
    } catch {
    } finally {
      setLoading(false);
        ...
        <div className="ui-flex-between">
          <div>
            ...
            <p className="ui-text-sm-muted">
              Monitor subscriber resource limits, storage consumption, users
              growth, and transaction API request volumes.
            </p>
          </div>
          <button
            ...
            <div className="ui-stack-6">
              ...
              <div className={styles.metricGrid}>
                ...
                <div className="ui-card p-5">
                  ...
                  <strong className="text-2xl">
                    {analytics.apiHitsCount.toLocaleString()}
                  </strong>
              ...
              <div className="ui-card p-5">
                <div className="ui-flex-between mb-4">
                  ...
                  <span className={styles.storageAmount}>
                    {formatSize(analytics.storageUsedBytes)} /{" "}
                    {formatSize(analytics.storageLimitBytes)} (
                    {calculatePercent(
                      analytics.storageUsedBytes,
                      analytics.storageLimitBytes,
                    )}
                    %)
                  </span>
                </div>
                ...
                <span className="ui-text-xs-muted">
                  Storage includes database files, document templates,
