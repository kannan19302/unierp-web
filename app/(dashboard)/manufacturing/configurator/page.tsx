    ...
    try {
      ...
      await client.post("/manufacturing/boms", {
        ...
        routingJson: JSON.stringify([
          {
            sequence: 1,
            name: "CNC precision casing adjust",
            workstationCode: "WS-CNC",
            durationMinutes: 90,
          },
          {
            sequence: 2,
            name: "Assembly of custom components",
            workstationCode: "WS-ASM",
            durationMinutes: 180,
          },
          {
            sequence: 3,
            name: "Custom system flashing & calibration",
            workstationCode: "WS-ASM",
            durationMinutes: 45,
          },
          {
            sequence: 4,
            name: "Packaging and custom label application",
      ...
      <div className="ui-stack-6">
        ...
        <div>
          ...
          <p className={styles.p2}>
            Configure custom product requirements, calculate cost roll-up
            adjustments, and generate customized Bills of Materials (BOM)
            automatically.
          </p>
        </div>
        ...
        {loading ? (
          <div className="text-center p-12">
            Loading configurator components...
          </div>
        ) : (
                ...
                <div className="ui-stack-3">
                  <div className={styles.p14}>
                    <span className="ui-text-sm-muted">
                      Base Model Materials Cost
                    </span>
                    <span className="font-bold">${basePrice.toFixed(2)}</span>
                  </div>
                  <div className={styles.p15}>
                    <span className="ui-text-sm-muted">
                      Specification Upgrade Price
                    </span>
                    <span className={styles.p16}>
                      +${optionPrice.toFixed(2)}
                    </span>
                  </div>
                  <div className={styles.p17}>
                    <span className="ui-text-sm-muted">
                      Routing Workstation Overhead Rate
                    </span>
                    <span className="font-bold">
                      +${routingOverhead.toFixed(2)}
                    </span>
                  </div>
                  <div className={styles.p18}>
                    <span className={styles.p19}>
                      Total Roll-Up Cost Standard
                    </span>
              ...
              {generatedBOM ? (
                <div className={styles.p21}>
                  ...
                  <p className={styles.p23}>
                    BOM Code: <strong>{generatedBOM}</strong> has been
                    registered in the system database. You can now Dispatch a
                    Work Order using this template.
                  </p>
                </div>
              ) : (
                <button
