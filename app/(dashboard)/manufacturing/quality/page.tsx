...
export default function QualityManagement() {
  ...
  const [selectedNcr, setSelectedNcr] = useState<NonConformanceReport | null>(
    null,
  );
  ...
  const handleResolveNcr = async (e: React.FormEvent) => {
    ...
    try {
      await client.request(`/manufacturing/quality/ncr/${selectedNcr.id}`, {
        method: "PATCH",
        ...
        <div className="ui-flex-between">
          <div>
            ...
            <p className={styles.p2}>
              Manage quality inspection plans, template parameters builder, and
              resolve non-conformance reports.
            </p>
          </div>
          ...
          <div className={styles.p5}>
            ...
            <div className={styles.p6}>
              ...
              <div className="ui-stack-3">
                  ...
                  <div key={ncr.id} className={styles.p8}>
                    ...
                    <div className={styles.p9}>
                      <div className="ui-text-micro">
                        <span>
                          <strong>Product:</strong> {ncr.product.name} (
                          {ncr.product.sku})
                        </span>
                        {ncr.workOrder && (
                          <span className={styles.p10}>
                            <strong>WO:</strong> {ncr.workOrder.workOrderNumber}
                          </span>
                        )}
                      </div>
                      <div>
                ...
                {ncrs.length === 0 && (
                  <div className={styles.p12}>No active NCR issues logged.</div>
                )}
              </div>
            </div>
                  ...
                  <div key={plan.id} className={styles.p15}>
                    ...
                    <div className={styles.p17}>
                      ...
                      <ul className={styles.p19}>
                        {(typeof plan.checks === "string"
                          ? JSON.parse(plan.checks)
                          : plan.checks
                        ).map((check: CheckItem, idx: number) => (
                          <li key={idx} className="ui-text-muted">
                            {check.parameter}:{" "}
                            {check.type === "PASS_FAIL"
                              ? "Pass/Fail Check"
                              : `Min ${check.minVal} / Max ${check.maxVal}`}
                          </li>
                        ))}
                      </ul>
                    </div>
            ...
            <form onSubmit={handleCreatePlan} className={styles.p21}>
              ...
              <div>
                <div className="ui-flex-between mb-2">
                  <label className={styles.p25}>
                    Parameters & Validation Specs
                  </label>
                  <button
                    type="button"
                    onClick={() =>
              ...
              <div className="ui-flex-end ui-gap-2 mt-2">
                ...
                <button type="submit" className={styles.p35}>
                  Save Plan
                </button>
              </div>
            </form>
            ...
            <form onSubmit={handleLogInspection} className={styles.p37}>
              ...
              <div>
                <div className={styles.p44}>
                  <label className={styles.p45}>
                    Inspection Parameters Roster
                  </label>
                  <button
                    type="button"
                    onClick={() =>
              ...
              <div className="ui-flex-end ui-gap-2 mt-2">
                ...
                <button type="submit" className={styles.p55}>
                  Submit Audit
                </button>
              </div>
            </form>
          ...
          <div className={styles.p56}>
            <form onSubmit={handleResolveNcr} className={styles.p57}>
              ...
              <p className="ui-text-xs-muted">
                Set resolution status and material disposition path for:{" "}
                <strong>{selectedNcr.title}</strong>
              </p>

              <div>
                <label className="ui-text-xs-label">
                  Material Disposition Path
                </label>
                <select
                ...
                >
                  ...
                  <option value="SCRAP">
                    Scrap (Dispose material completely)
                  </option>
                  <option value="ACCEPT_AS_IS">
                    Accept As-Is (Minor cosmetic deviations)
                  </option>
                  <option value="RETURN_TO_VENDOR">
                    Return to Vendor (Component defect)
                  </option>
                </select>
              </div>
              ...
              <div className="ui-flex-end ui-gap-2 mt-2">
                <button
                  ...
                  className={styles.p60}
                >
                  Cancel
                </button>
                <button type="submit" className={styles.p61}>
                  Submit Resolution
                </button>
              </div>
            </form>
