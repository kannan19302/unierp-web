  ...
  return (
    <div className="ui-stack-6">
      <div className="ui-flex-between">
        <div>
          <h1 className={styles.p1}>
            <Activity size={28} className="ui-text-primary" /> KPI Dashboard
          </h1>
            ...
            return (
              <div key={k.id} className={styles.kpiCard}>
                ...
                <div className={styles.kpiMeta}>
                  {pct !== null && (
                    <span
                      className={pct >= 0 ? styles.upChange : styles.downChange}
                    >
                      {pct >= 0 ? (
                        <TrendingUp size={12} />
                      ) : (
                  ...
                  {k.targetValue !== null && (
                    <span
                      className={
                        meetingTarget ? styles.onTarget : styles.offTarget
                      }
                    >
                      Target: {k.targetValue?.toLocaleString()}
                      {k.unit}
                    </span>
                  )}
                </div>
                <p className={styles.kpiDate}>
      ...
      {kpis.length === 0 && !loading && (
        <div className="ui-text-muted">No KPI values recorded yet.</div>
      )}
      {isModalOpen && (
          ...
          <div className={styles.modal}>
            ...
            <form onSubmit={handleCreate} className="ui-stack-3">
              ...
              <div className="ui-grid-3">
                ...
                <div className="ui-form-group">
                  <label className="ui-label">Previous</label>
                  <input
                    className="ui-input"
                    type="number"
                    step="any"
              ...
              <div className="ui-form-group">
                <label className="ui-label">Unit (e.g., $, %, units)</label>
                <input
                  className="ui-input"
                  value={newKpi.unit}
                  onChange={(e: any) =>
