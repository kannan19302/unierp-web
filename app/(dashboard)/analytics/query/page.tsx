...
export default function VisualQueryBuilderPage() {
  ...
  const askInPlainEnglish = async () => {
    ...
    try {
      ...
      setNlError(
        e instanceof Error ? e.message : "Could not reach the AI copilot.",
      );
    } finally {
      setNlAsking(false);
    }
      ...
      <div className="ui-stack-6">
        ...
        <div className="ui-flex-between">
          <div>
            ...
            <p className="ui-text-sm-muted">
              Build ad-hoc queries with drag-and-drop fields, joins, filters,
              and aggregations — no SQL knowledge required.
            </p>
          </div>
        ...
        <div className={styles.s3}>
          <h3 className={styles.s4}>
            <Sparkles size={14} className="ui-text-primary" /> Ask in Plain
            English
          </h3>
          <div className="ui-flex ui-gap-2">
            <input
            ...
            <button
              ...
              style={{
                cursor:
                  nlAsking || !nlQuestion.trim() ? "not-allowed" : "pointer",
        ...
        <div className={styles.s10}>
                ...
                <div className={styles.s14}>
                  {t.columns.map((col: any) => (
                    <button
                      ...
                      className={`${styles.s15} ${styles.fieldHover}`}
                    >
                      {col}
                    </button>
                  ))}
          ...
          <div className="ui-stack-4">
            ...
            <div className="ui-card p-4">
              <h3 className="ui-section-header">SELECT Fields</h3>
