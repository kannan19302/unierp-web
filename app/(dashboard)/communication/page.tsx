...
export default function CommunicationDashboard() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const ws = await client.get<WorkspaceSummary>(
  ...
  const messageTrend = [
    { name: "Mon", messages: 140 },
    { name: "Tue", messages: 210 },
    { name: "Wed", messages: 185 },
    { name: "Thu", messages: 245 },
    { name: "Fri", messages: 160 },
    { name: "Sat", messages: 65 },
  ];
          ...
          <Card>
            <div className="p-5">
              ...
              <div className="ui-stack-3">
                {[
                  {
                    label: "New channel #marketing created by Sarah",
                    time: "10 mins ago",
                  },
                  {
                    label: 'Meeting "Q3 Strategy Planning" starts in 1 hour',
                    time: "50 mins ago",
                  },
                  {
