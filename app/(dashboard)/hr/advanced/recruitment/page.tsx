...
export default function RecruitmentPage() {
  ...
  const [jobs, setJobs] = useState<
    Array<{ id: string; title: string; status: string; postedAt: string }>
  >([]);
  ...
  const handleOfferStatus = async (id: string, status: string) => {
    try {
      await client.request(`/api/v1/advanced-hr/offers/${id}/status`, {
        method: "PUT",
    ...
    <RouteGuard permission="hr.recruitment.read">
      <div className="ui-stack-6">
        ...
        <div className="ui-flex ui-gap-3">
          <Button
            variant={tab === "jobs" ? "primary" : "outline"}
            onClick={() => setTab("jobs")}
          >
                        ...
                        <div key={stage} className={styles.s5}>
                          ...
                          <div className={styles.s9}>
                            ...
                            {stageApplicants.length === 0 && (
                              <div className={styles.s16}>Empty Stage</div>
                            )}
                          </div>
                        </div>
                      );
                        ...
                        return o.status === "SENT" ? (
                          <div className={styles.s17}>
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleOfferStatus(o.id, "REJECTED")
                              }
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleOfferStatus(o.id, "ACCEPTED")
                              }
                            >
                              Accept
                            </Button>
