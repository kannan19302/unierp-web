...
export default function LeavesPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      notifyError("Failed to load leave management data", message);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleApprove = async (id: string, approve: boolean) => {
    try {
      await client.request(
        `/api/v1/advanced-hr/leaves/requests/${id}/approve`,
        {
          method: "PUT",
        ...
        <div className={styles.stats}>
          ...
          <Card padding="md">
            <div className="ui-hstack-4">
              ...
              <div>
                <div className="ui-heading-lg">{policies.length}</div>
                      ...
                      <div className="ui-flex-between mb-2">
                        <div>
                          ...
                          <div className={styles.policyName}>
                            {req.policy?.name || "Leave Policy"} (
                            {req.policy?.leaveType})
                          </div>
                        </div>
