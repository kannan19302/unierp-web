...
export default function PositionsPage() {
    ...
    try {
      ...
      const message =
        err instanceof Error
          ? err.message
          : "Failed to load position control data";
      setLoadError(message);
      notifyError("Failed to load position control data", message);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleCreatePosition = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMsg(message);
      notifyError("Failed to create position", message);
    }
  };
  ...
  const handleUpdateStatus = async (
    ...
    try {
      ...
      setMsg(message);
      notifyError("Failed to update position", message);
    }
  };
          ...
          <div className={styles.s5}>
            ...
            <div className="ui-stack-4">
              <h4 className={styles.s6}>
                <BarChart3 size={16} /> Budget Variance
              </h4>
              {variances.length === 0 ? (
