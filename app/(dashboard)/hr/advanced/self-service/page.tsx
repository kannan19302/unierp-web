...
export default function SelfServicePage() {
  ...
  const fetchData = async () => {
    ...
    setError(null);
    try {
      const dashboardData = await client.get<SelfServiceData>(
        "/advanced-hr/self-service/dashboard",
      );
  ...
  return (
    <div className="ui-stack-6 ui-animate-in">
      ...
      {msg && <div className={styles.s1}>{msg}</div>}
      ...
      {loading ? (
        ...
        <div className={styles.s2}>
          ...
          <div className="ui-stack-6">
            <Card padding="md">
              <div className={styles.s3}>
                <div className={styles.s4}>{data.employee.name.charAt(0)}</div>
                <div>
              ...
              <div className={styles.s7}>
                <div className="ui-hstack-2">
                  ...
                  <span>
                    Joined{" "}
                    {new Date(data.employee.dateOfJoining).toLocaleDateString()}
                  </span>
                </div>
                {data.employee.phone && (
                  <div className="ui-hstack-2">
          ...
          <div className="ui-stack-6">
            {/* Recent Payslips */}
            <Card padding="md">
              <h4 className={styles.s15}>
                <DollarSign size={16} /> Recent Salary Payslips
              </h4>
              <ListPageTemplate
                title=""
                columns={
                ...
                data={
                  data.recentPayslips as unknown as Record<string, unknown>[]
                }
                loading={false}
            ...
            <Card padding="md">
              <h4 className={styles.s18}>
                <ClipboardList size={16} /> Leave Status
              </h4>
              <ListPageTemplate
                title=""
                columns={
                ...
                data={
                  data.pendingLeaves as unknown as Record<string, unknown>[]
                }
                loading={false}
            ...
            {/* Assigned Assets */}
            <Card padding="md">
              <h4 className={styles.s19}>
                <Briefcase size={16} /> Assigned Company Assets
              </h4>
                  ...
                  data.assignedAssets.map((asset) => (
                    <Card key={asset.id} padding="sm" className={styles.s21}>
                      ...
                      <div className="ui-text-caption">
                        {asset.assetType} • S/N: {asset.serialNumber}
                      </div>
            ...
            <Card padding="md">
              <h4 className={styles.s24}>
                <FileText size={16} /> Documents & Contracts
              </h4>
                ...
                {data.documents.length === 0 ? (
                  ...
                  data.documents.map((doc) => (
                    <div key={doc.id} className={styles.s26}>
                      ...
                      {doc.fileUrl ? (
                        <a href={doc.fileUrl} download className={styles.s28}>
                          Download File
                        </a>
                      ) : (
        ...
        <div className="text-center p-12">
          ...
          <p>
            We could not find an Employee Profile linked to your user account.
          </p>
        </div>
      )}
    </div>
