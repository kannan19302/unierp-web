...
import { Card, PageHeader, Button, Spinner, ListPageTemplate, useToast, type ListColumn } from "@kannan19302/ui";
import {
  CalendarDays,
  Plus,
  Clock,
...
export default function ShiftsPage() {
  ...
  const [filterType, setFilterType] = useState<"ALL" | "TODAY" | "UPCOMING">(
    "ALL",
  );
          ...
          {(() => {
            const filteredShifts = shifts.filter((s) => {
              if (
                ...
                return false;
              if (filterType === "UPCOMING" && !isUpcoming(s.startTime))
                return false;
              if (
                searchQuery.trim() &&
