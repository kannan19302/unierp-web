...
import { Award, Plus, Star, AlertTriangle } from "lucide-react";
...
export default function AppraisalsPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      notifyError("Failed to load appraisals", message);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="ui-stack-6 ui-animate-in">
        ...
        {loadError && (
          <div className="ui-alert ui-alert-danger">
            ...
            Failed to load appraisals — data below may be stale or incomplete.{" "}
            {loadError}
          </div>
        )}
        ...
        <div className={styles.stats}>
          ...
          <Card padding="md">
            <div className="ui-stack-2">
              <span className={styles.statLabel}>Review Calibration</span>
              ...
              <p className={styles.statDescription}>
                Variance: +
                {totalAppraisals
                  ? (averageSelfScore - averageManagerScore).toFixed(1)
                  : "0.0"}{" "}
                (Self vs Manager)
              </p>
            </div>
                ...
                return (
                  <div key={star} className={styles.distributionRow}>
                    ...
                    <div className={styles.distributionTrack}>
                      <div
                        className={styles.distributionValue}
                        style={{ width: `${pct}%` }}
                      />
                    </div>
            ...
            <form onSubmit={createAppraisal} className="ui-stack-3">
              ...
              <div className="ui-grid-2 ui-gap-3">
                ...
                >
                  ...
                  <option value="4">
                    4 - High Performing (Exceeds expectations)
                  </option>
                  <option value="3">
                    3 - Solid Performing (Meets expectations)
                  </option>
                  <option value="2">
              ...
              appraisals.map((app) => (
                <Card key={app.id} padding="md">
                  ...
                  <div className={styles.period}>
                    Period:{" "}
                    <span className="font-semibold">{app.appraisalPeriod}</span>
                  </div>
