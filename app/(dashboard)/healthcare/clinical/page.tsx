...
export default function ClinicalNotesPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await client.get<Encounter[] | { data?: Encounter[] }>(
          "/api/v1/ext/healthcare/encounters",
        );
  ...
  const handleCreate = async () => {
    ...
    setCreating(true);
    try {
      await client.post("/api/v1/ext/healthcare/encounters", {
        ...form,
    ...
    <RouteGuard permission="healthcare.encounter.read">
      <div className="ui-stack-6">
        ...
        <div className="ui-grid-auto">
          ...
          <KPICard
            title="Total Billing"
            value={fmtCurrency(totalBilling)}
