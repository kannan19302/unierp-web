...
import { PageHeader, Card, Spinner, Badge, KPICard } from "@kannan19302/ui";
import {
  Users,
  Heart,
  Calendar,
      ...
      <div className="ui-stack-6">
        ...
        <div className="ui-grid-auto-sm">
          ...
          <KPICard
            ...
            icon={<Heart size={18} />}
            color={
              patient.allergies ? "var(--color-danger)" : "var(--color-success)"
            }
          />
        </div>
        ...
        <Card>
          <div className="p-5">
            <h3 className="ui-heading-base mb-4">
              <Activity size={16} className={styles.s6} /> Vitals History
            </h3>
            <div className={styles.s7}>
              <Activity size={40} />
              <p className={styles.s8}>
                {patient.vitalsHistory || "No vitals data recorded yet."}
              </p>
            </div>
          </div>
        </Card>
