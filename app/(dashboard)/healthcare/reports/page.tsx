...
const PATIENT_TREND = [
  { name: "Jan", new: 28, total: 380 },
  { name: "Feb", new: 35, total: 415 },
  { name: "Mar", new: 22, total: 437 },
  { name: "Apr", new: 40, total: 477 },
  { name: "May", new: 18, total: 495 },
  { name: "Jun", new: 32, total: 527 },
];

const APPOINTMENT_UTIL = [
  { name: "Mon", scheduled: 30, completed: 28 },
  { name: "Tue", scheduled: 35, completed: 32 },
  { name: "Wed", scheduled: 28, completed: 25 },
  { name: "Thu", scheduled: 40, completed: 38 },
  { name: "Fri", scheduled: 25, completed: 24 },
  { name: "Sat", scheduled: 15, completed: 14 },
];

const RX_BY_CATEGORY = [
  { name: "Antibiotics", count: 45 },
  { name: "Analgesics", count: 38 },
  { name: "Cardiovascular", count: 32 },
    ...
    <div className="ui-stack-6">
      ...
      <div className="ui-grid-2">
        <DashboardChart
          ...
          subtitle="New patients and cumulative total"
          data={PATIENT_TREND}
          config={{
            xAxisKey: "name",
            series: [
          ...
          allowedChartTypes={["composed", "bar", "area"]}
          height={280}
        />
        <DashboardChart
          title="Appointment Utilization"
          subtitle="Scheduled vs completed appointments"
      ...
      <div className="ui-grid-2">
        <DashboardChart
          ...
          subtitle="Top medication categories"
          data={RX_BY_CATEGORY}
          config={{
            xAxisKey: "name",
            series: [
        ...
        <DashboardChart
          title="Revenue Trend"
          subtitle="Monthly billing revenue"
          data={REVENUE_TREND}
          config={{
            xAxisKey: "name",
            series: [
