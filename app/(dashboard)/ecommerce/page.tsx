...
export default function EcommerceConfigPage() {
  ...
  const fetchConfig = useCallback(async () => {
    ...
    setError(null);
    try {
      const data = await client.get<StorefrontConfig | null>(
        "/ecommerce/config",
      );
      if (data) {
        setConfig({
                ...
                <div className={styles.s3}>
                  ...
                  <div>
                    ...
                    <div className="ui-text-xs-tertiary">
                      No storefront has been configured yet. Fill in the details
                      below and save to create it.
                    </div>
                  </div>
                </div>
              </Card>
              ...
              <div className={styles.s4}>
                <div className={styles.s5}>
                  <div>
                    ...
                    <div className="ui-text-xs-tertiary">
                      When enabled, /store/{config.storeSlug || "[slug]"}{" "}
                      becomes reachable to external customers.
                    </div>
                  </div>
                  <ProtectedComponent
