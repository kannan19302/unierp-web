...
export default function AssetInsurancePage() {
  ...
  useEffect(() => {
    apiGet("/fixed-assets-deep/insurance")
      .then((d: any) => setPolicies(Array.isArray(d) ? d : []))
  ...
  const columns: Column<Record<string, unknown>>[] = [
    ...
    { key: "coverageAmount", header: "Coverage" },
  ...
  return (
    <div>
      ...
      <div className="ui-card">
        ...
        >
          <Button leftIcon={<Plus size={16} />}>Add Policy</Button>
        </div>
