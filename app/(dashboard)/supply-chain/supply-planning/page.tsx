  ...
  if (loading)
    return (
      <div className="ui-page">
        <PageHeader title="Supply Planning" />
        <div
  ...
  return (
    <div className="ui-page">
      <PageHeader
        ...
        description="Demand sensing, supply plans, and S&OP"
        actions={
          <Button variant="primary" onClick={() => setCreateOpen(true)}>
            <Plus size={14} /> New Supply Plan
          </Button>
        }
      />
      <Tabs
        ...
        tabs={[
          { key: "plans", label: `Supply Plans (${plans.length})` },
          { key: "sop", label: `S&OP Plans (${sopPlans.length})` },
          { key: "demand", label: `Demand Runs (${demandRuns.length})` },
        ]}
      />
      <Card>
        {activeTab === "plans" && (
        ...
        {activeTab === "demand" && (
          <DataTable
            columns={[
              ...
              { key: "runType", header: "Type" },
              { key: "algorithm", header: "Algorithm" },
              { key: "horizonMonths", header: "Horizon" },
              {
                key: "status",
                header: "Status",
                render: (r: any) => <StatusBadge status={r.status} />,
