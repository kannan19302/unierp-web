...
export default function SupplierAssessmentsPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await client.get<Assessment[]>(
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      const created = await client.post<Assessment>(
        "/supply-chain/supplier-assessments",
        form,
      );
      ...
      <div className="ui-stack-6">
        ...
        <Card padding="none">
          <DataTable
            ...
            emptyMessage="Create your first supplier assessment."
              ...
              <Card key={a.id}>
                <div className="ui-stack-3">
                  <h4 className="ui-heading-sm">
                    Assessment Details — {a.vendor}
                  </h4>
                  {a.findings && a.findings.length > 0 && (
                    <div>
                      <div
                        className="ui-text-xs-tertiary ui-uppercase"
