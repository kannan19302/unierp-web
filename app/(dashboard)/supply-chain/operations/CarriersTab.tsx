...
export default function CarriersTab() {
  ...
  const fetchCarriers = async () => {
    try {
      const data = await client.get<Carrier[] | { data?: Carrier[] }>(
      ...
      render: (row: any) =>
        row.trackingUrl ? (
          <a
            ...
            className="ui-hstack-1 ui-items-center text-xs text-primary hover:underline"
          >
      ...
      <div className="ui-stack-6">
        <div className="ui-flex-end">
          <Button variant="primary" onClick={() => setCreateOpen(true)}>
            <Plus size={14} className="mr-2" /> Add Carrier
          </Button>
        </div>
