...
export default function SupplyChainDashboard() {
  ...
  const fetchData = async () => {
    try {
      const data = await client.get<Shipment[] | { data?: Shipment[] }>(
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    setCreating(true);
    try {
      await client.post("/supply-chain/shipments", {
        ...form,
    ...
    },
    {
      ...
      render: (row: any) =>
        row.trackingNumber ? (
          ...
          <span className="ui-text-xs-tertiary">—</span>
        ),
    },
    {
      key: "weight",
