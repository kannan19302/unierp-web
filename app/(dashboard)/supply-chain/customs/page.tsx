...
import { PageHeader, Card, Button, Spinner, Badge, DataTable, type Column, Modal, TextField, FormField, Select, Pagination } from "@kannan19302/ui";
    ...
    },
    {
      ...
      render: (row: any) =>
        row.clearedDate ? (
          ...
          <span className="ui-text-xs-muted">—</span>
        ),
    },
    {
      key: "actions",
      ...
      render: (row: any) => (
        <div className="ui-flex ui-gap-1" onClick={(e: any) => e.stopPropagation()}>
          <button
            ...
            onClick={() =>
              window.open(`/supply-chain/customs/${row.id}`, "_blank")
            }
          >
            <svg
              width="14"
      ...
      <div className="ui-stack-6">
        ...
        <Card padding="none">
          <DataTable
            ...
            emptyTitle="No customs documents"
            emptyMessage="Create your first customs declaration."
            ...
            <div className="ui-grid-2 ui-gap-3">
              <FormField label="Type">
                ...
                >
                  ...
                  <option value="CERT_OF_ORIGIN">Cert of Origin</option>
