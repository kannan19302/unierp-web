...
export default function ContractsPage() {
  ...
  useEffect(() => {
    fetchData();
  }, [page, sortBy, sortOrder, statusFilter, vendorSearch]);
      ...
      render: (row: any) => (
        <div className="ui-flex ui-gap-1" onClick={(e) => e.stopPropagation()}>
          <button
            ...
            onClick={() =>
              window.open(`/supply-chain/contracts/${row.id}`, "_blank")
            }
          >
            <Eye size={14} />
          </button>
          <button className="ui-btn-icon" onClick={() => openEdit(row)}>
            <Edit size={14} />
          </button>
          <button
      ...
      <div className="ui-stack-6">
        ...
        <Card padding="none">
          <DataTable
            ...
            emptyMessage="Create your first supplier contract."
        ...
        <Modal
          ...
          footer={
            <>
              <Button variant="secondary" onClick={() => setEditContract(null)}>
                Cancel
              </Button>
              <Button
                variant="primary"
