...
export default function ProfilePage() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      setUser(data);
      setFormData({ firstName: data.firstName || '', lastName: data.lastName || '', language: data.preferences?.language || 'English (US)', theme: data.preferences?.theme || 'System Default' });
    } catch {
      // profile not loaded
    } finally {
      setLoading(false);
  ...
  return (
    ...
    <div className={`max-w-7xl mx-auto md:p-8 animate-fade-in-up ${styles.s2}`} >
      <div className="ui-stack-2">
        <h1 className={styles.s3}>User Profile</h1>
        <p className="ui-text-sm-muted">Manage your personal information, security, and preferences.</p>
      </div>
          ...
          <div className="ui-stack-4">
            <div className={styles.s6}>
              ...
              <div className="ui-flex-col">
                ...
                <span className="ui-text-xs-muted mt-1">JPG, GIF or PNG. Max size of 800K</span>
              </div>
            </div>
            ...
            <div className="ui-form-group">
              ...
              <input className="ui-input bg-muted" defaultValue={user?.email || ''} readOnly />
              <p className="ui-text-xs-muted mt-1">Contact your admin to change your email address.</p>
            </div>

            <div className="ui-form-group">
              <label className="ui-label">Job Title / Role</label>
              <input className="ui-input bg-muted" defaultValue={user?.roles?.join(', ') || 'Employee'} readOnly />
            </div>

            <hr className="border-border my-2" />
            
            <div className="ui-form-group">
              <label className="ui-hstack-2"><Globe size={14}/> Language</label>
              <select 
                className="ui-input" 
            ...
            <div className="ui-form-group">
              <label className="ui-hstack-2"><Monitor size={14}/> Theme</label>
              <select 
                className="ui-input" 
                ...
                onChange={(e) => {
                  ...
                  setTheme(val === 'Dark Mode' ? 'dark' : val === 'Light Mode' ? 'light' : 'system');
                }}
              >
        ...
        <div className="ui-stack-4">
          <div className="ui-card">
            ...
            <div className="ui-stack-4">
              ...
              <div className="ui-flex-between">
                <div>
                  <h4 className={styles.s9}><Smartphone size={16}/> Two-Factor Authentication</h4>
                  <p className="ui-text-xs-muted mt-1">Add an extra layer of security to your account.</p>
                </div>
