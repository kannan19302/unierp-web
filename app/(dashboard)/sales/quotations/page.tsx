...
export default function QuotationsPage() {
  ...
  const [quoteDetails, setQuoteDetails] = useState<QuotationDetail | null>(
    null,
  );
  ...
  return (
    <RouteGuard permission="sales.quotation.read">
      <div className="ui-stack-6 ui-animate-in">
        ...
        {/* Quotes Listing */}
        <div
          style={{ gridTemplateColumns: selectedQuote ? "1.5fr 1fr" : "1fr" }}
        >
          <ListPageTemplate
            title=""
            columns={
          ...
          {selectedQuote && (
            <Card padding="none" className={styles.p10}>
              <div className={styles.p11}>
                <h4 className={styles.p12}>
                  {selectedQuote.quotationNumber} Details
                </h4>
                <button
                  ...
                  <div className="p-5 ui-stack-4">
                    ...
                    <div className="ui-flex-between">
                      ...
                      <span className={styles.p13}>
                        <Calendar size={14} />{" "}
                        {new Date(quoteDetails.validUntil).toLocaleDateString()}
                      </span>
                    </div>
                    ...
                    <div className={styles.p19}>
                      <div className={styles.p20}>
                        <span>Subtotal:</span>
                        <span>
                          ${Number(quoteDetails.subtotal).toLocaleString()}
                        </span>
                      </div>
                      <div className={styles.p21}>
                        <span>Sales Taxes:</span>
                        <span>
                          ${Number(quoteDetails.taxAmount).toLocaleString()}
                        </span>
                      </div>
                      <div className={styles.p22}>
                        <span>Total Proposal Value:</span>
                        <span>
                          ${Number(quoteDetails.totalAmount).toLocaleString()}
                        </span>
                      </div>
                    </div>
                    ...
                    {quoteDetails.status !== "CONVERTED" && (
                      <div className={styles.p26}>
                        <Button
                          variant="primary"
                          onClick={() => convertToOrder(quoteDetails.id)}
                ...
                {modalSuccess ? (
                  <div className={styles.p33}>
                    ...
                    <p className="ui-text-sm-muted">
                      Quotation saved to database registry.
                    </p>
                  </div>
                ) : (
                  <>
                    ...
                    <div className={styles.p42}>
                      ...
                      <Button
                        ...
                        disabled={submitting}
                      >
                        {submitting ? <Spinner size="sm" /> : "Save Proposal"}
                      </Button>
                    </div>
                  </>
                )}
