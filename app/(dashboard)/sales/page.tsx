              ...
              <div className={styles.p2}>
                ...
                <div className={styles.p4}>
                  <span className="ui-heading-sm">
                    Attention Needed: Credit Hold Orders Detected
                  </span>
                  <span className={styles.p5}>
                    {creditHolds.length} B2B order(s) are blocked because
                    customers have exceeded their credit limits.
                  </span>
                </div>
                <Link
                ...
                renderCard={(item) => (
                  <div>
                    ...
                    <div className="ui-flex-between">
                      <span className={styles.p11}>{item.salesChannel}</span>
                      <span
                        style={{
                          color:
                    ...
                    <div className="ui-stack-3">
                      <div className="ui-hstack-3">
                        ...
                        <div>
                          ...
                          <span className="ui-text-xs-muted">
                            Create & convert client quotations
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="ui-stack-3">
                      <div className="ui-hstack-3">
                        ...
                        <div>
                          ...
                          <span className="ui-text-xs-muted">
                            Track shipments and inventory dispatch
                          </span>
                        </div>
                      </div>
                      <div className={styles.p24}>
                        <span className="ui-text-xs-muted">
                          Manage goods delivery notes
                        </span>
                        <Link
                ...
                {(() => {
                  ...
                  return (
                    <div className={styles.p28}>
                      <ListPageTemplate
                        title="Recent Sales Actions"
                        columns={orderColumns}
                        data={
                          orders.slice(0, 5) as unknown as Record<
                            string,
                            unknown
                          >[]
                        }
                        ...
                        <div className="ui-stack-3">
                          <div>
                            ...
                            <div className={styles.p31}>
                              <div
                                style={{
                                  width: `${totalRevenue > 0 ? (b2bRevenue / totalRevenue) * 100 : 0}%`,
                                }}
                              ></div>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className={styles.p34}>
                              <div
                                style={{
                                  width: `${totalRevenue > 0 ? (d2cRevenue / totalRevenue) * 100 : 0}%`,
                                }}
                              ></div>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className={styles.p37}>
                              <div
                                style={{
                                  width: `${totalRevenue > 0 ? (b2cRevenue / totalRevenue) * 100 : 0}%`,
                                }}
                              ></div>
                            </div>
                          </div>
