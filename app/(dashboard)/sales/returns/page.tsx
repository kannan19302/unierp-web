...
import { Card, PageHeader, Button, Spinner, Badge, ListPageTemplate, type ListColumn, DataTable } from "@kannan19302/ui";
import {
  Plus,
  Search,
  X,
...
export default function SalesReturnsPage() {
  ...
  const handleOrderChange = async (orderId: string) => {
    ...
    try {
      const data = await client.get<SalesOrderDetail>(
            ...
            <div className={styles.p27}>
              <div className={styles.p28}>
                <h3 className="ui-heading-base">
                  Log Customer Return & Issue Credit Note
                </h3>
                <button
              ...
              {modalSuccess ? (
                <div className={styles.p29}>
                  ...
                  <div className="ui-text-sm-muted">
                    The inventory items have been restocked, and a Credit Note
                    was generated.
                  </div>
                </div>
              ) : (
