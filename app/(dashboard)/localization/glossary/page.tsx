...
export default function GlossaryPage() {
  ...
  useEffect(() => {
    apiGet("/admin/localization/glossary")
  ...
  const columns: Column<Record<string, unknown>>[] = [
    ...
    { key: "sourceLanguage", header: "Source Lang" },
    { key: "targetLanguage", header: "Target Lang" },
  ...
  return (
    <div>
      ...
      <div className="ui-card">
        ...
        >
          <Button leftIcon={<Plus size={16} />}>Add Term</Button>
        </div>
