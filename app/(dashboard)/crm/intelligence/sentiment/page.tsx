                ...
                <div className={styles.sentimentSummary}>
                  ...
                  <div className="flex-1 ui-stack-2">
                    ...
                    <p className={styles.sentimentExplanation}>
                      Analysis indicates overall{" "}
                      <b>{sentimentData.label?.toLowerCase()}</b> tone in recent
                      messages and calendar interactions.
                    </p>
                  </div>
                </div>
              ) : (
                  ...
                  <div className="ui-flex-between">
                    <div>
                      ...
                      <div
                        ...
                        style={{
                          color:
                            dealHealth.indicator === "green"
                              ? "var(--color-success)"
                              : dealHealth.indicator === "yellow"
                                ? "var(--color-warning)"
                                : "var(--color-danger)",
                        }}
                      >
                  ...
                  <div className={styles.healthSignals}>
                    ...
                    <div className={styles.signalRow}>
                      ...
                      <span className="font-bold">
                        {dealHealth.signals?.stageStrength || 0} pts
                      </span>
                    </div>
                    ...
                    <div className={styles.signalRow}>
                      <span className="ui-flex ui-items-center ui-gap-1">
                        <CheckCircle2 size={12} color="var(--color-success)" />{" "}
                        Deal Amount Strength
                      </span>
                      <span className="font-bold">
                        {dealHealth.signals?.amountStrength || 0} pts
                      </span>
                    </div>
                    ...
                    <div className={styles.signalRow}>
                      <span className="ui-flex ui-items-center ui-gap-1">
                        <AlertCircle
                          size={12}
                          color={
                            dealHealth.signals?.recencyAdjustment >= 0
                              ? "var(--color-success)"
                              : "var(--color-danger)"
                          }
                        />{" "}
                        Recency & Activity Adjustment
                      </span>
                      <span
                        className={styles.recencyValue}
                        style={{
                          color:
                            dealHealth.signals?.recencyAdjustment >= 0
                              ? "var(--color-success)"
                      ...
                      >
                        {dealHealth.signals?.recencyAdjustment >= 0 ? "+" : ""}
                        {dealHealth.signals?.recencyAdjustment || 0} pts
                      </span>
                    </div>
                  </div>
                </div>
