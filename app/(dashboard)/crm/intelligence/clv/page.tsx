    ...
    const fetchCLV = async () => {
      ...
      try {
        const res = await client.get<any>(
          `/crm/customers/${selectedCustomer}/clv`,
        );
              ...
              <div className="ui-stack-6">
                <Card padding="md">
                  ...
                  <div className={styles.valueGrid}>
                    ...
                    <div
                      className={`${styles.valueCard} ${styles.predictedValue}`}
                      style={
                        {
                          "--tier-color": getTierColor(clvData.clvTier),
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ color: getTierColor(clvData.clvTier) }}
                      >
                  ...
                  <div className={styles.tierSummary}>
                    ...
                    <span
                      ...
                      style={{ background: getTierColor(clvData.clvTier) }}
                    >
                  ...
                  <div className="ui-stack-3">
                    <div className="ui-flex-between text-xs">
                      ...
                      <span className="font-bold">
                        ${clvData.avgOrderValue?.toLocaleString()}
                      </span>
                    </div>
                    <div className="ui-flex-between text-xs">
                      <span className="ui-text-muted">Purchase Frequency</span>
                      <span className="font-bold">
                        Every {clvData.purchaseFrequencyMonths} months
                      </span>
                    </div>
                    <div className="ui-flex-between text-xs">
                      <span className="ui-text-muted">
              ...
              <Card padding="md">
                ...
                <div className={styles.retentionPanel}>
                  <div className={styles.retentionCircle}>
                    <div
                      className={styles.retentionRing}
                      style={{
                        borderColor:
                          clvData.retentionProbability >= 80
                            ? "var(--color-success)"
                            : clvData.retentionProbability >= 60
                              ? "var(--color-warning)"
                              : "var(--color-danger)",
                      }}
                    />
                    <span className={styles.retentionPercent}>
                      {clvData.retentionProbability}%
                    </span>
                  </div>

                  <div
                    className={styles.retentionStatus}
                    style={{
                      color:
                        clvData.retentionProbability >= 80
                          ? "var(--color-success)"
