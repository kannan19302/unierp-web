...
import { Card, PageHeader, Spinner, Button, StatusBadge, DataTable } from "@kannan19302/ui";
        ...
        <div className={`ui-grid-2 ${styles.grid}`}>
          <Card>
            <div className="ui-card-header">
              <h3 className="ui-card-title">Stage Duration Averages</h3>
            </div>
          ...
          <Card>
            <div className="ui-card-header">
              <h3 className="ui-card-title">Stagnating Deals</h3>
            </div>
            <div className="ui-card-body">
                  ...
                  {velocity.stagnatingDeals.map((d: any) => (
                    <div key={d.id} className={styles.stagnatingCard}>
                      ...
                      <p className={styles.stagnatingDescription}>
                        Stage: {d.stage} | {d.daysInStage}d in stage (avg:{" "}
                        {d.avgForStage}d) | {d.customerName}
                      </p>
                    </div>
                  ))}
                </div>
