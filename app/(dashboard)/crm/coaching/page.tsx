...
export default function CoachingPage() {
  const [tab, setTab] = useState<"dashboard" | "rubrics" | "library">(
    "dashboard",
  );
          ...
          {loading ? (
            ...
            <div className="ui-empty-state">
              ...
              <div className="text-sm">
                Score a logged call against a rubric to populate the team
                dashboard.
              </div>
            </div>
          ) : (
        ...
        <Card>
          ...
          {loading ? (
            ...
            <div className="ui-empty-state">
              ...
              <div className="text-sm">
                Create a scoring rubric to start structured call reviews.
              </div>
            </div>
          ) : (
            <DataTable<Rubric>
        ...
        <Card>
          {loading ? (
            ...
            <div className="ui-empty-state">
              ...
              <div className="text-sm">
                Add exemplar calls/notes from the call detail view.
              </div>
            </div>
          ) : (
          ...
          <Card>
            <div className={styles.modalContent}>
              ...
              <div className="ui-text-sm-muted">
                Creates a rubric with 4 standard criteria: Talk Ratio Balance,
                Discovery Quality, Objection Handling, Next Steps Set.
              </div>
              <Button
                variant="primary"
                onClick={createRubric}
                disabled={busy || !rubricForm.name}
              >
                Create Rubric
              </Button>
            </div>
