...
export default function ConversionAnalyticsPage() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const [summaryData, sourceData, campaignData, repData, trendData] =
        await Promise.all([
        ...
        <Badge
          variant={
            r.overallLeadToWonRate >= 10
              ? "success"
              : r.overallLeadToWonRate >= 3
                ? "default"
                : "danger"
          }
        >
          {r.overallLeadToWonRate}%
        </Badge>
      ),
    },
  ];
    ...
    <div className="ui-stack-6 ui-animate-in">
      ...
      {loading ? (
        ...
        <Card>
          <div className="ui-empty-state">
            ...
            <div className="text-sm">
              Once leads start flowing in, funnel conversion rates will appear
              here.
            </div>
          </div>
        </Card>
        ...
        <>
            ...
            <Card>
              <div className="p-4">
                ...
                <div className="text-2xl">
                  {summary.qualifiedToConvertedRate}%
                </div>
              </div>
            </Card>
            <Card>
          ...
          <Card>
            <div className={styles.trendHeader}>Trailing 12-Week Trend</div>
