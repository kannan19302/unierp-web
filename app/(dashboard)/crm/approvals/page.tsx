          ...
          <div className={styles.p216}>
            <div className={styles.p217}>
              <div className={styles.p218}>
                <h3 className={styles.p219}>
                  {actionModal.type === "approve" ? (
                    <CheckCircle size={20} className="ui-text-success" />
                  ) : (
                    <AlertTriangle size={20} className="ui-text-danger" />
                  )}
                  {actionModal.type === "approve"
                    ? "Approve Request"
                    : "Reject Request"}
              ...
              <div className={styles.p221}>
                <div>
                  <strong>{actionModal.request.processName}</strong>
                </div>
                <div className={styles.p222}>
                  {actionModal.request.entityType} -{" "}
                  {actionModal.request.entityId}
                </div>
              </div>
              ...
              <div className={styles.p225}>
                ...
                <Button
                  ...
                  disabled={
                    submitting ||
                    (actionModal.type === "reject" && !comments.trim())
                  }
                >
                  {submitting ? (
                    <Spinner size="sm" />
