...
export default function OpportunityDetailPage() {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      console.warn("Failed to load products for line-item picker.", err);
    }
  }, [client]);
      ...
      const probability =
        newStage === "CLOSED_WON"
          ...
          : newStage === "CLOSED_LOST"
            ? 0
            : undefined;
      await client.patch(`/crm/opportunities/${id}/stage`, {
        stage: newStage,
        probability,
      });
    ...
    return (
      <div className="ui-stack-4">
        <div className="ui-alert ui-alert-danger">
          {fetchError
            ? `Failed to load opportunity: ${fetchError}`
              ...
              {activeTab === "items" && (
                <Card padding="md" className="ui-stack-4">
                  <div className="ui-flex-between">
                    <h4 className={styles.sectionTitleNoMargin}>
                      Products & Items
                    </h4>
                    <Button
                      variant="primary"
                  ...
                  <ListPageTemplate
                      ...
                      [
                        {
                          ...
                          render: (v: any) =>
                            v ? (
                              <span>
                                <Package size={14} className={styles.s5} />
                                {(v as any).name}
                              </span>
                            ) : (
                              <span className={styles.s3}>Custom</span>
                            ),
                        },
                        ...
                        },
                        {
                          ...
                          render: (v: any) => (
                            <button
                              onClick={() => handleDeleteLineItem(String(v))}
                    ...
                    data={
                      (opp.lineItems || []) as unknown as Record<
                        string,
                        unknown
                      >[]
                    }
        ...
        >
          <form onSubmit={handleAddLineItem} className={styles.itemForm}>
            ...
            <div className={styles.modalActions}>
              ...
              <Button type="submit" variant="primary" disabled={submittingItem}>
