      ...
      <div className={styles.page}>
        ...
        <div className={styles.summaryGrid}>
          <Card className={styles.summaryCard}>
            <div className={styles.s1}>{dashboards.length}</div>
            <div className={styles.summaryLabel}>Total Dashboards</div>
          </Card>
          <Card className={styles.summaryCard}>
        ...
        <div className={styles.dashboardGrid}>
          {dashboards.map((db) => (
            ...
            >
              ...
              {db.description && <p className={styles.s8}>{db.description}</p>}

              <div className={styles.s9}>
                <Grid3X3 className={styles.s23} />
                <span className={styles.s10}>
                  {db.widgetCount} {db.widgetCount === 1 ? "widget" : "widgets"}{" "}
                  configured
                </span>
              </div>
