...
import { Card, StatusBadge, Spinner, Button, Modal, FormField, Input, Textarea } from "@kannan19302/ui";
import {
  BookOpen,
  Plus,
  Layers,
    ...
    <div className={styles.style1}>
      ...
      <div className={styles.s1}>
        <Card className={styles.style3}>
          <div className={styles.style4}>{playbooks.length}</div>
          <div className={styles.style5}>Total Playbooks</div>
        </Card>
          ...
          <Card key={pb.id} className={styles.style16}>
            <div className="ui-flex-between ui-items-start">
              <div className={styles.style17}>
                ...
                <h3 className={styles.style19}>{pb.name}</h3>
              </div>
              <StatusBadge status={pb.isActive ? "ACTIVE" : "INACTIVE"} />
            </div>

            {pb.description && <p className={styles.s2}>{pb.description}</p>}
            ...
            <div className={styles.s4}>
              ...
              <span className="ui-flex ui-items-center ui-gap-1">
                ...
                {pb.battlecards.length}{" "}
                {pb.battlecards.length === 1 ? "battlecard" : "battlecards"}
              </span>
            </div>
