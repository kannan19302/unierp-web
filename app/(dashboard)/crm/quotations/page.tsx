...
export default function CrmQuotationsPage() {
  ...
  const sortedQuotations = [...filteredQuotations].sort((a, b) => {
    ...
    if (sortBy === "totalAmount")
      ...
      cmp = a.quotationNumber.localeCompare(b.quotationNumber);
    else if (sortBy === "issueDate" || sortBy === "createdAt")
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newQ: Quotation = {
        id: `q-${Date.now()}`,
        quotationNumber: form.quotationNumber || `Q-${Date.now()}`,
        status: "DRAFT",
        totalAmount: total,
    ...
    <RouteGuard permission="crm.read">
      <div className="ui-stack-6">
          ...
          actions={
            <div className="ui-flex ui-gap-2">
              ...
              <Button variant="primary" onClick={() => setCreateOpen(true)}>
                <Plus size={14} className="mr-2" /> New Quotation
              </Button>
            </div>
          }
        />
        ...
        <div className="ui-grid-auto">
          ...
          <KPICard
            title="Won Value"
            value={fmtCurrency(acceptedValue)}
        ...
        <Card padding="none">
          <DataTable
            ...
            emptyMessage="Create your first quotation to start quoting customers."
        ...
        <Modal
          ...
          description="Build a new quote with line items"
          size="lg"
          footer={
            <>
        ...
        <Modal
          ...
          title={selected?.quotationNumber || "Quotation"}
          size="md"
          footer={
            selected ? (
              <>
          ...
          {selected && (
            <div className="ui-stack-4">
              <div className="ui-grid-2">
                ...
                <div>
                  <div className="ui-text-xs-tertiary">Issue Date</div>
                  <div>{new Date(selected.issueDate).toLocaleDateString()}</div>
                </div>
                <div>
                  <div className="ui-text-xs-tertiary">Valid Until</div>
                  <div>
                    {selected.validUntil
