            ...
            <div className="p-5">
              ...
              <div className={styles.style6}>
                <span className="ui-flex ui-items-center ui-gap-1">
                  <Layers size={14} /> {seq.steps.length} steps
                </span>
                <span className="ui-flex ui-items-center ui-gap-1">
                  <Users size={14} /> {seq.enrollmentCount} enrolled
                </span>
              </div>
              {/* Steps preview */}
                  ...
                  >
                    ...
                    {step.delayDays > 0 && (
                      <span className={styles.style10}>
                        <Clock size={10} /> +{step.delayDays}d
                      </span>
                    )}
                  </div>
                ))}
                ...
                <div key={idx} className={styles.style13}>
                  <div className={styles.style14}>
                    ...
                    <button
                      ...
                      style={{
                        cursor:
                          idx === formSteps.length - 1 ? "default" : "pointer",
                        opacity: idx === formSteps.length - 1 ? 0.3 : 1,
                      }}
                      className={styles.s3}
                    >
                      <ChevronDown size={14} />
