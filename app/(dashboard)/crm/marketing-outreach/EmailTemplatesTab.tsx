...
const FALLBACK: EmailTemplate[] = [
  ...
  },
  {
    ...
    category: "QUOTATION",
    subject: "Following up on your quote {{quotation.number}}",
  ...
  },
  {
    ...
    category: "FOLLOWUP",
    subject: "Meeting Confirmed - {{meeting.date}}",
    ...
    <div className="ui-stack-6">
      ...
      <Card padding="none">
        <DataTable
          ...
          emptyMessage="Create your first template to streamline outreach."
          emptyIcon={<Mail size={48} />}
        />
      </Card>
      ...
      >
        <form onSubmit={handleCreate} className="ui-stack-4">
          ...
          <FormField
            label="Email Body"
            required
            hint="Supports HTML and {{variable}} placeholders"
          >
            <Textarea
              rows={10}
              value={form.body}
          ...
          <div className={styles.style11}>
            <strong>Available variables:</strong> {"{{customer.name}}"},{" "}
            {"{{customer.email}}"}, {"{{company.name}}"}, {"{{sender.name}}"},{" "}
        ...
        {selected && (
          <div className="ui-stack-4">
            <div className="ui-flex-between">
              <Badge
                variant={
                  (categoryColors[selected.category] || "default") as any
                }
              >
                {selected.category}
              </Badge>
