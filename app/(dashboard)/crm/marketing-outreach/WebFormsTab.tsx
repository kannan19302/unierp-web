        ...
        <Card>
          <div className="ui-empty-state">
            ...
            <div className="text-sm">
              Create a web form to start capturing leads.
            </div>
          </div>
        </Card>
      ) : (
              ...
              <div className="p-5">
                ...
                <div className="ui-flex ui-gap-2">
                  ...
                  <Button
                    variant="secondary"
                    onClick={() =>
                      setPreviewFormId(previewFormId === f.id ? null : f.id)
                    }
        ...
        <Card>
          ...
          <div className={styles.style9}>
            <form onSubmit={(e) => e.preventDefault()} className="ui-stack-4">
              {previewForm.fields.map((f, i) => (
                <div key={i}>
                  <label style={labelStyle}>
                    {f.label}{" "}
                    {f.required && <span className="ui-text-danger">*</span>}
                  </label>
                  {f.type === "TEXTAREA" ? (
                    <textarea
                      disabled
                    ...
                    <select disabled className="ui-input" style={inputStyle}>
              ...
              <Button variant="primary" disabled className={styles.style10}>
                Submit
              </Button>
            </form>
          </div>
        ...
        <form onSubmit={handleCreate} className={styles.style11}>
          ...
          <div>
            <div className={styles.style12}>
              <label style={{ ...labelStyle }} className={styles.s2}>
                Form Fields
              </label>
              <button
                type="button"
          ...
          {/* Settings */}
          <div>
            <label style={{ ...labelStyle }} className={styles.s4}>
              Settings
            </label>
