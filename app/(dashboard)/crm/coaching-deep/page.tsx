...
export default function CoachingDeepPage() {
  const [tab, setTab] = useState<"programs" | "dashboard">("programs");
  ...
  return (
    <div className="ui-page">
      ...
      <div className={styles.tabs}>
        ...
        <Link href="/crm/coaching-deep/effectiveness">
          <button className={styles.tab}>Effectiveness</button>
        </Link>
        <Link href="/crm/coaching-deep/recommendations">
          <button className={styles.tab}>Recommendations</button>
        </Link>
      </div>
