...
export default function LeadScoringPage() {
  ...
  return (
    <div className="ui-stack-6">
        ...
        actions={
          <div className="ui-flex ui-gap-2">
            <ProtectedComponent permission="crm.lead-scoring.recalculate">
              ...
              >
                <RefreshCw size={14} />{" "}
                {recalcing ? "Queuing…" : "Recalculate All"}
              </Button>
            </ProtectedComponent>
      ...
      {flash && <div className={styles.style0}>{flash}</div>}
      {error && (
      ...
      <Card padding="none">
        {rules.length === 0 ? (
          <div className={styles.style2}>
            ...
            <p className="text-sm">
              No scoring rules configured. Create your first rule to start
