...
export default function CustomFieldsPage() {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const created = await client.post<any>("/crm/custom-fields", {
        ...form,
  ...
  const addOption = () =>
    setForm((prev) => ({
      ...
      options: [
        ...prev.options,
        { value: "", label: "", color: "var(--color-text-tertiary)" },
      ],
    }));
        ...
        <Card>
          <div className={styles.style3}>
            <div className={styles.style4}>
              {activeEntity} Fields ({filtered.length})
            </div>
            <Button
              onClick={() => {
                setForm(emptyForm(activeEntity));
                ...
                },
                {
                  ...
                  render: (v: any) =>
                    v ? (
                      ...
                      <span className={styles.style6}>No</span>
                    ),
                },
                {
                  key: "section",
                ...
                },
                {
                  ...
                  render: (v: any) =>
                    v ? (
                      ...
                      <ToggleLeft size={20} className={styles.style7} />
                    ),
                },
                {
                  key: "id",
                ...
                <div className={styles.style25}>
                  ...
                  <Button type="submit" disabled={submitting}>
                    {submitting ? (
                      ...
                      <>
                        <Save size={16} className="mr-1" /> Create Field
                      </>
                    )}
                  </Button>
                </div>
