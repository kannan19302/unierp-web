          ...
          <div className={styles.style6}>
            <div className={styles.style7}>
              <div className={styles.style8}>
                Approval Processes ({filtered.length})
              </div>
            ...
            >
              <Plus size={16} className="mr-1" /> New Process
            </Button>
          </div>
          <ListPageTemplate
            columns={
                ...
                },
                {
                  ...
                  render: (v: any) => (
                    <div className={styles.style11}>
                      ...
                      <button
                        onClick={() => setDeleteConfirm(String(v))}
                ...
                <div className={styles.style23}>
                  ...
                  <Button type="submit" disabled={submitting}>
                    {submitting ? (
                      ...
                      <>
                        <Save size={16} className="mr-1" /> Create Process
                      </>
                    )}
                  </Button>
                </div>
          ...
          <div className={styles.style24}>
            <div className={styles.style25}>
              <div className={styles.style26}>
                ...
                <div>
                  ...
                  <p className={styles.style29}>
                    This will permanently remove the process and all associated
                    rules.
                  </p>
                </div>
              </div>
              <div className={styles.style30}>
                ...
                <Button onClick={() => handleDeleteProcess(deleteConfirm)}>
                  Delete
                </Button>
              </div>
            </div>
