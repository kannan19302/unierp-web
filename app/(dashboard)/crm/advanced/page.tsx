    ...
    modules: [
      {
        ...
        label: "Customers",
        icon: <Users size={18} />,
        desc: "Customer directory with credit limits and payment terms",
      },
      {
        href: "/crm/vendors",
        label: "Vendors",
        icon: <Building size={18} />,
        desc: "Vendor and supplier management",
      },
      {
        href: "/crm/contacts",
        label: "Contacts",
        icon: <Users size={18} />,
        desc: "Contact persons linked to customer accounts",
      },
    ],
  },
  {
    ...
    modules: [
      {
        ...
        desc: "Kanban board and list view for lead management",
      },
      {
        href: "/crm/opportunities",
        label: "Opportunities",
        icon: <BarChart3 size={18} />,
        desc: "Pipeline Kanban with stage tracking and deal amounts",
      },
      {
        href: "/crm/quotations",
        label: "Quotations",
        icon: <FileText size={18} />,
        desc: "Customer quotes and proposals",
      },
      {
        href: "/crm/sales-orders",
        label: "Sales Orders",
        icon: <ClipboardList size={18} />,
        desc: "Order fulfillment tracking",
      },
    ],
  },
  {
    ...
    modules: [
      {
        ...
        desc: "Call, email, meeting, and task logging",
      },
      {
        href: "/crm/email-templates",
        label: "Email Templates",
        icon: <Mail size={18} />,
        desc: "Reusable templates with variable insertion",
      },
      {
        href: "/crm/reports",
        label: "CRM Reports",
        icon: <PieChart size={18} />,
        desc: "Pipeline funnel, win rate, and lead source analytics",
      },
    ],
  },
];
          ...
          <div className={styles.p22}>
            {group.modules.map((mod: any) => (
              <Link key={mod.href} href={mod.href} className={styles.p23}>
                <Card
                  padding="md"
                  className={`hover:shadow-md transition-all hover:border-primary/30 ${styles.p24}`}
                >
