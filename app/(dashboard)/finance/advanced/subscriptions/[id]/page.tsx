...
export default function SubscriptionDetailPage() {
  ...
  const handleCancel = async () => {
    if (!sub) return;
    if (
      !confirm("Are you sure you want to cancel this subscription immediately?")
    )
      return;
    try {
    ...
    },
    {
      ...
      render: (row: SubscriptionUsage) => (
        <span className="text-sm text-slate-500">
          {fmt(row.unitAmount, sub.currency)}
        </span>
      ),
    },
    {
      ...
      render: (row: SubscriptionUsage) => (
        <span className="text-sm font-semibold">
          {fmt(row.totalAmount, sub.currency)}
        </span>
      ),
    },
  ];
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          <Card className="p-6">
            <h2 className="text-md font-semibold text-slate-800 border-b pb-3 mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-slate-800 mt-0.5">
                  {fmt(Number(sub.unitAmount) * sub.quantity, sub.currency)} /{" "}
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-slate-800 mt-0.5">
                  {sub.billingCycles !== null
                    ? `${sub.billingCycles} Cycles Remaining`
                    : "Infinite"}
                </p>
              </div>
              <div>
              ...
              <div className="col-span-2">
                ...
                <p className="text-sm font-semibold text-slate-800 mt-0.5">
                  {new Date(sub.currentPeriodStart).toLocaleDateString()} to{" "}
        ...
        <div className="space-y-6">
          <Card className="p-6 space-y-4">
            <h2 className="text-md font-semibold text-slate-800 border-b pb-3">
              Log Usage
            </h2>
