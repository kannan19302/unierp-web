...
export default function NewSubscriptionPage() {
  ...
  const handleAddLine = () => {
    setLines([
      ...lines,
      { description: "", unitAmount: 0, quantity: 1, taxRate: 0 },
    ]);
  };
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm ui-text-muted mt-1">
            Register a new client subscription contract
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card className="p-6 space-y-4">
          <h2 className="text-md font-semibold text-slate-800 border-b pb-2">
            Plan Information
          </h2>
        ...
        <Card className="p-6 space-y-4">
          ...
          {lines.length === 0 ? (
            <p className="text-sm text-slate-400 italic">
              No additional line items added. The base subscription pricing
              above will be used.
            </p>
          ) : (
