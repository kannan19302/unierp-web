        ...
        <form onSubmit={submit} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-xs font-medium ui-text-muted">
                Lease Reference
              </label>
              <input
                className="ui-input w-full"
                placeholder="e.g. LEASE-HQ-2024"
                value={form.leaseRef}
                onChange={set("leaseRef")}
              />
            </div>
            <div className="space-y-1">
              <label className="text-xs font-medium ui-text-muted">
          ...
          <div className="space-y-1">
            ...
            <input
              className="ui-input w-full"
              placeholder="e.g. Office space — HQ floor 3"
          ...
          <p className="text-xs ui-text-muted bg-blue-50 dark:bg-blue-900/20 rounded p-3">
            On save, the system will automatically generate a monthly
            amortization schedule using the effective-interest method (ASC 842 /
            IFRS 16).
          </p>
