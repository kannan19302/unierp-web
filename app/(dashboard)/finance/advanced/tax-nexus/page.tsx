  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold ui-text-primary">Economic Nexus Monitoring</h1>
          <p className="text-sm ui-text-muted mt-1">Trailing-12-month sales/use-tax nexus threshold tracking by state</p>
        </div>
      ...
      {dashboard && (
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <Card className="p-4">
            ...
            <p className="text-2xl font-bold ui-text-primary">{dashboard.totalStatesMonitored}</p>
          </Card>
          <Card className="p-4">
          ...
          <Card className="p-4">
            ...
            <p className="text-2xl font-bold ui-text-primary">${dashboard.totalRevenue.toLocaleString('en-US', { minimumFractionDigits: 0 })}</p>
          </Card>
        </div>
      )}
