...
export default function ScenarioComparisonPage() {
  ...
  const handleCompare = async () => {
    ...
    try {
      setComparison(
        await client.get<ComparisonResult>(
        ...
        <div className="ui-page-head">
          <div className="ui-page-head-content">
            ...
            <p className="ui-page-subtitle">
              Analyze variances between budget scenarios (Base vs Downside) or
              compare budget scenarios vs actual GL ledger outcomes.
            </p>
          </div>
        </div>
              ...
              {(() => {
                      ...
                      return (
                        <div>
                          <div className="font-semibold">
                            {acc ? `${acc.code} — ${acc.name}` : (v as string)}
                          </div>
                ...
                return (
                  <ListPageTemplate
                    columns={compColumns}
                    data={
                      comparison.rows as unknown as Record<string, unknown>[]
                    }
                    loading={false}
