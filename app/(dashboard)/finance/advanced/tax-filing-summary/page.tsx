...
export default function TaxFilingSummaryPage() {
  ...
  const fetchSummary = useCallback(async () => {
    ...
    try {
      setSummary(
        await client.get<FilingSummary>(
          `/advanced-finance/tax-filings/summary?year=${year}`,
        ),
      );
    } catch {
    } finally {
        ...
        <div className="ui-flex-between ui-items-start">
          <div>
            ...
            <p className="ui-text-muted mt-1">
              Compliance dashboard displaying GST/VAT returns, computed
              liability, filing statuses, and tax audit readiness.
            </p>
          </div>
                ...
                {(() => {
                  ...
                  return (
                    <ListPageTemplate
                      ...
                      data={
                        summary.filings as unknown as Record<string, unknown>[]
                      }
                      loading={false}
