...
const MOCK_STATEMENTS: BankStatement[] = [
  {
    id: "s1",
    date: "2026-06-28",
    description: "Wire from Wayne Enterprises",
    amount: 15000,
    type: "CREDIT",
    matched: true,
    matchedTo: "INV-2026-001",
  },
  {
    id: "s2",
    date: "2026-06-27",
  ...
  },
  {
    id: "s5",
    date: "2026-06-24",
    description: "Client Payment - Stark Industries",
    amount: 25000,
    type: "CREDIT",
    matched: true,
    matchedTo: "INV-2026-003",
  },
];
    ...
    },
    {
      ...
      render: (row) => {
        const pct = Math.round(
          (row.matchedCount / row.totalTransactions) * 100,
        );
        return (
          ...
          actions={
            <div className="ui-flex ui-gap-2">
              <Button variant="outline" onClick={() => setImportOpen(true)}>
                <Upload size={14} className="mr-2" /> Import Statement
              </Button>
        ...
        <Card padding="none">
          {activeTab === "reconciliations" ? (
            <DataTable
              ...
              emptyMessage="Import a bank statement to start."
            ...
            <DataTable
              ...
              emptyMessage="Import a CSV bank statement."
          ...
          <div className="ui-stack-4">
            <FormField label="Bank Account" required>
              <Select>
                ...
                <option value="1">Chase Business Checking</option>
                <option value="2">Wells Fargo Savings</option>
              </Select>
            </FormField>
