    ...
    try {
      setData(
        await client.get<Analytics>(
          `/advanced-finance/analytics/invoices?months=${months}`,
        ),
      );
    } catch {
        ...
        <div className="ui-flex-between ui-items-start">
          <div>
            ...
            <p className="ui-text-muted mt-1">
              Track sales invoice trends, average collection days, customer
              payment velocities, and payment statuses.
            </p>
          </div>
                ...
                {(() => {
                  ...
                  return (
                    <ListPageTemplate
                      ...
                      data={
                        data.monthlyTrend as unknown as Record<
                          string,
                          unknown
                        >[]
                      }
                ...
                {(() => {
                  ...
                  return (
                    <ListPageTemplate
                      columns={custColumns}
                      data={
                        data.topCustomers as unknown as Record<
                          string,
                          unknown
                        >[]
                      }
                ...
                {data.statusBreakdown.map((stat) => {
                  ...
                  return (
                    <div
                      ...
                      className={styles.s9}
                    >
                      <p style={{ color: color }} className={styles.s10}>
                        {stat.status}
                      </p>
                      <p style={{ color: color }} className={styles.s11}>
                        {fmt(stat.amount)}
                      </p>
                      <p className="ui-text-xs-muted mt-1">
                        {stat.count} invoice(s)
                      </p>
                    </div>
                  );
                })}
