...
import { PageHeader, Card, Button, Spinner, TextField, FormField, Select, KPICard } from "@kannan19302/ui";
...
export default function FeePaymentPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const d = await client.get<StudentFee[] | { data?: StudentFee[] }>(
  ...
  const handlePayment = async () => {
    ...
    setProcessing(true);
    try {
      await client.post("/ext/education/student-fees/pay", {
          ...
          <Card>
            <div className={styles.s1}>
              ...
              <p className="ui-text-sm-muted">
                The fee payment of {fmtCurrency(Number(paymentAmount))} has been
                processed.
              </p>
              <Button
                variant="primary"
          ...
          <div className={styles.s4}>
            ...
            <div className="ui-stack-4">
                  ...
                  {unpaidFees.map((f) => (
                    <option key={f.id} value={f.id}>
                      {f.student
                        ...
                        : f.studentId}{" "}
                      — {f.feeStructure?.name || "Fee"} (
                      {fmtCurrency(f.amount - f.paidAmount)} due)
                    </option>
                  ))}
                </Select>
              </FormField>
                ...
                <div className={styles.s5}>
                  ...
                  <div className={styles.s6}>
                    ...
                    <span className="ui-text-success">
                      {fmtCurrency(selected.paidAmount)}
                    </span>
                  </div>
              ...
              <Button
                ...
                disabled={processing || !selectedFee || !paymentAmount}
              >
