...
import { PageHeader, Card, Button, Spinner, Badge, KPICard, ChangeHistory } from "@kannan19302/ui";
import {
  GraduationCap,
  BookOpen,
  DollarSign,
...
export default function StudentDetailPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const data = await client.get<Student[] | { data?: Student[] }>(
          "/ext/education/students",
        );
        {
          ...
          <Card>
            <div className="p-5">
              ...
              <div className={styles.s5}>
                <BookOpen size={40} />
                <p className="text-sm">
                  Course enrollment details will appear here.
                </p>
              </div>
            </div>
          </Card>
