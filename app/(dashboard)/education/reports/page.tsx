...
const ENROLLMENT_BY_YEAR = [
  { name: "2022", students: 280 },
  { name: "2023", students: 320 },
  { name: "2024", students: 380 },
  { name: "2025", students: 420 },
    ...
    <div className="ui-stack-6">
      ...
      <div className="ui-grid-2">
        ...
        <DashboardChart
          ...
          subtitle="Monthly collected vs outstanding"
          data={FEE_COLLECTION}
          config={{
            xAxisKey: "name",
            series: [
      ...
      <div className="ui-grid-2">
        <DashboardChart
          ...
          subtitle="Student grade breakdown"
