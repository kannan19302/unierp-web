...
export default function RealEstateDashboard() {
  ...
  const rentCollection = [
    { name: "Jan", collected: 125000, pending: 15000 },
    { name: "Feb", collected: 130000, pending: 12000 },
    { name: "Mar", collected: 128000, pending: 18000 },
    { name: "Apr", collected: 135000, pending: 8000 },
    { name: "May", collected: 132000, pending: 14000 },
    { name: "Jun", collected: 140000, pending: 10000 },
  ];
      ...
      <div className="ui-stack-6">
        ...
        <div className="ui-grid-2">
          ...
          <DashboardChart
            ...
            subtitle="Monthly collected vs pending"
            data={rentCollection}
            config={{
              xAxisKey: "name",
              series: [
