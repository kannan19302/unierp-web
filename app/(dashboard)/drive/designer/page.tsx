...
export default function DriveDesignerPage() {
  const [templateBlocks, setTemplateBlocks] = useState<TemplateBlock[]>([
    ...
    },
    {
      ...
      content: "Authorized Signature: _______________",
    },
    {
      id: "blk-6",
      type: "footer",
      label: "Footer",
      content: "© 2026 Acme Corp | Terms & Conditions Apply",
    },
  ]);
    ...
    <div className="ui-stack-6">
      <div>
        ...
        <p className="ui-text-sm-muted">
          Drag-and-drop block-based template builder for invoices, purchase
          orders, payslips, and other document types.
        </p>
      </div>
        ...
        <div className={styles.p4}>
          <div className="ui-flex-between mb-4">
            ...
            <div className="ui-flex ui-gap-2">
              ...
              <button className={styles.p7}>Save Template</button>
            </div>
          </div>
                ...
                <div className="ui-flex-between">
                  ...
                  <div className={styles.p9}>
                    ...
                    <button
                      ...
                      disabled={idx === templateBlocks.length - 1}
                      style={{
                        cursor:
                          idx === templateBlocks.length - 1
                            ? "not-allowed"
                            : "pointer",
                        opacity: idx === templateBlocks.length - 1 ? 0.3 : 1,
                      }}
                      className={styles.s1}
                    >
                      ↓
