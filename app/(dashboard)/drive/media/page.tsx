  ...
  const rules = [
    {
      ...
      savings: "~65%",
      enabled: true,
      desc: "Convert uploaded images to WebP for faster page loads",
    },
    {
      from: "Images",
      to: "Thumbnails",
      savings: "150×150px",
      enabled: true,
      desc: "Generate thumbnail previews for all uploaded images",
    },
    {
      from: "HEIC/HEIF",
      to: "JPEG",
      savings: "Compatibility",
      enabled: true,
      desc: "Convert Apple HEIC photos to widely supported JPEG",
    },
    {
      from: "PDF",
      to: "Preview PNG",
      savings: "First page",
      enabled: false,
      desc: "Generate a PNG preview of the first page of uploaded PDFs",
    },
    {
      from: "Video",
      to: "Poster Frame",
      savings: "First frame",
      enabled: false,
      desc: "Extract first frame as video poster image",
    },
    {
      from: "SVG",
      to: "PNG Raster",
      savings: "Fallback",
      enabled: false,
      desc: "Rasterize SVG uploads into PNG for legacy viewer support",
    },
    {
      from: "TIFF",
      to: "JPEG",
      savings: "~80%",
      enabled: false,
      desc: "Convert large TIFF scans to compressed JPEG for faster access",
    },
  ];
    ...
    <div className="ui-stack-6">
      <div>
        ...
        <p className="ui-text-sm-muted">
          Configure automatic media conversion rules for uploaded files. Enable
          WebP compression, thumbnail generation, and format conversions.
        </p>
      </div>
            ...
            <div className="ui-hstack-3">
              ...
              <div>
                <div className="ui-heading-sm">
                  {rule.from} → {rule.to}{" "}
                  <span className={styles.p3}>({rule.savings})</span>
                </div>
