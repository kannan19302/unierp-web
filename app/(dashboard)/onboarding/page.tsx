...
const MODULES = [
  {
    ...
    description: "GL, AR/AP, Invoicing",
    icon: "💰",
  },
  {
    id: "hr",
    name: "Human Resources",
    description: "Employees, Payroll, Time off",
    icon: "👥",
  },
  {
    id: "crm",
    name: "CRM",
    description: "Leads, Opportunities, Customers",
    icon: "🎯",
  },
  {
    id: "inventory",
    name: "Inventory",
    description: "Stock, Warehouses, Fulfillment",
    icon: "📦",
  },
  {
    id: "sales",
      ...
      case 1:
        return (
          <div className={styles.stepContent}>
            ...
            <p>
              Let's get your workspace set up. This will only take a few
              minutes.
            </p>
          </div>
        );
        ...
        return (
          <div className={styles.stepContent}>
            ...
            <button
              type="button"
              onClick={() =>
                setTeam([...team, { email: "", role: "employee" }])
              }
            >
              + Add another
            </button>
