...
export default function FavoritesPage() {
  ...
  const removeFavorite = async (slug: string) => {
    try {
      ...
      setToast({
        message: e instanceof Error ? e.message : "Failed to remove favorite",
        type: "error",
      });
    }
  };
      ...
      <div className="ui-stack-5 ui-animate-in">
        ...
        {loadError && (
          <div className="ui-alert ui-alert-danger">
            Failed to load favorites — the list below may be incomplete.{" "}
            {loadError}
          </div>
        )}
        ...
        {favorites.length === 0 ? (
          <div className="ui-empty-state">
            ...
            <h3 className="ui-empty-state-title">
              {loadError ? "Couldn't load favorites" : "No favorites yet"}
            </h3>
            <p className="ui-empty-state-text">
              {loadError ? (
                ...
                <>
                  ...
                  and heart apps you want to save for later.
                </>
              )}
            </p>
          </div>
              ...
              return (
                ...
                >
                  <Button
                    ...
                    onClick={() => removeFavorite(app.slug)}
                  ...
                  >
                    ...
                    <div className="ui-hstack-2">
                      ...
                      <span className={styles.priceBadge}>
                        <Badge
                          variant={
                            app.pricing === "FREE" ? "success" : "warning"
                          }
                        >
