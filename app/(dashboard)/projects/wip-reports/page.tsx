...
import { PageHeader, Card, Badge, DataTable, type Column, KPICard, Spinner } from "@kannan19302/ui";
import {
  DollarSign,
  TrendingUp,
  Wallet,
      ...
      <div className="ui-stack-6">
        ...
        <div className={styles.p2}>
          ...
          <KPICard
            ...
            value={fmtCurrency(totalCostIncurred)}
            icon={<DollarSign size={20} />}
            color="var(--color-primary)"
          />
          <KPICard
            title="WIP Assets (Underbilled)"
            value={fmtCurrency(totalWipAssets)}
            icon={<TrendingUp size={20} />}
            color="var(--color-success)"
          />
          <KPICard
            title="WIP Liabilities (Overbilled)"
            value={fmtCurrency(totalWipLiabilities)}
