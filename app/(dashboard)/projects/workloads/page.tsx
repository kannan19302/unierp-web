  ...
  const fetchWorkloads = async () => {
    try {
      ...
      const data = await client.get<
        ResourceWorkload[] | { data?: ResourceWorkload[] }
      >("/projects/resource-workload");
      ...
      <div className="ui-stack-6">
        ...
        <div>
          ...
          <p className={styles.p2}>
            Monitor team allocations, verify capacity limits, and resolve
            over-allocations across active project tasks
          </p>
        </div>
