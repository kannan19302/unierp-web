    ...
    <div className="ui-stack-6">
      ...
      <div>
        ...
        <p className={styles.p2}>
          External client view-only portal for project status tracking,
          deliverables verification, and milestones compliance
        </p>
      </div>

      {/* Selector */}
      <div className={styles.p3}>
        <span className={styles.p4}>Select Active Project:</span>
        <select
      ...
      {selectedProject ? (
          ...
          <div className="ui-stack-6">
            ...
            <div className={styles.p7}>
              ...
              <div className="ui-hstack-4">
                ...
                <span className={styles.p10}>{percentComplete}% Complete</span>
              </div>
              <div className={styles.p11}>
                <div>
                  <p className="ui-text-caption ui-text-tertiary">
                    COMPLETED TASKS
                  </p>
        ...
        <div className="text-center p-12">
          No active project available to show client view.
        </div>
      )}
    </div>
  );
