    ...
    <div className="ui-stack-6">
      ...
      <div>
        ...
        <p className={styles.p2}>
          Run critical path calculation simulations, analyze delay risks, and
          view overall project key metrics
        </p>
      </div>
            ...
            <div className={styles.p7}>
              <div>
                <h3 className={styles.p8}>
                  {selectedProject.name} Health Status
                </h3>
              ...
              <div className={styles.p11}>
                ...
                <div className="ui-hstack-3">
                  <ShieldAlert
                    ...
                    style={{
                      color:
                        selectedProject.overallHealth === "CRITICAL"
                          ? "var(--color-danger)"
                          : "var(--color-success)",
                    }}
                  />
                  <div>
                    ...
                    <p className={styles.p13}>
                      Based on active milestones & task delays
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="ui-hstack-3">
                  ...
                  <div>
                    ...
                    <p className={styles.p17}>
                      Tasks that directly impact project end dates
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.p19}>
                <div className="ui-flex-between text-xs">
                  <span className="ui-text-muted">
                    Resource Over-allocations Trigger:
                  </span>
                  <strong className="ui-text-danger">
                    Critical Danger (Util &gt; 110%)
                  </strong>
                </div>
                <div className={styles.p20}>
                  <span className="ui-text-muted">
                    Task Predecessor Delay Threshold:
                  </span>
                  <strong>2.5 business days</strong>
                </div>
                <div className={styles.p21}>
                  <span className="ui-text-muted">
                    Baseline Alignment Variance:
                  </span>
