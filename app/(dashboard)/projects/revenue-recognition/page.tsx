        ...
        {unscoped > 0 && (
          <Card padding="md">
            <div className={styles.p3}>
              ...
              {unscoped} project(s) are missing a budget or start/end date and
              are excluded from the recognition schedule.
            </div>
          </Card>
        )}
