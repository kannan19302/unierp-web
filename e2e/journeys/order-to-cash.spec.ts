...
test.describe("Order-to-Cash", () => {
  ...
  test("complete order-to-cash flow", async ({
    page,
    salesOrderPage,
    invoicePage,
    paymentPage,
    ...
    const customerField = page
      .locator(
        '[name="customerId"], [name="customer"], [id*="customer"], [placeholder*="customer"]',
      )
      .first();
    ...
    const refField = page
      .locator('[name*="reference"], [name*="orderRef"], [name*="name"]')
      .first();
    ...
    const invoiceCustomerField = page
      .locator(
        '[name="customerId"], [name="customer"], [id*="customer"], [placeholder*="customer"]',
      )
      .first();
  ...
  test("invoice status transitions through payment", async ({
    page,
    invoicePage,
    dashboardPage,
  }: any) => {
    ...
    const statusText = await page
      .locator('[class*="badge"], [class*="status"], .ui-badge')
      .first()
      .textContent()
      .catch(() => "no-status");
